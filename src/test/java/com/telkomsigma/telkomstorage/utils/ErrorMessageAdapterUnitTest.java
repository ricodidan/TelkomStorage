...
public class ErrorMessageAdapterUnitTest {
    ...
    public void getErrorCauseMessageForForbiddenRemoval() {
        ...
        when(mMockResources.getString(com.telkomsigma.telkomstorage.R.string.forbidden_permissions))
                .thenReturn(MOCK_FORBIDDEN_PERMISSIONS);
        when(mMockResources.getString(com.telkomsigma.telkomstorage.R.string.forbidden_permissions_delete))
