...
public class UsersAndGroupsSearchProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        ...
        AUTHORITY = getContext().getResources().getString(com.telkomsigma.telkomstorage.R.string.users_and_groups_search_authority);
        ACTION_SHARE_WITH = getContext().getResources().getString(com.telkomsigma.telkomstorage.R.string.users_and_groups_share_with);
            ...
            try {
                while (namesIt.hasNext()) {
                    ...
                    if (ShareType.GROUP.getValue() == type) {
                        displayName = getContext().getString(com.telkomsigma.telkomstorage.R.string.share_group_clarification, userName);
                        icon = com.telkomsigma.telkomstorage.R.drawable.ic_group;
                        dataUri = Uri.withAppendedPath(groupBaseUri, shareWith);
                    } else if (ShareType.FEDERATED.getValue() == type && federatedShareAllowed) {
                        icon = com.telkomsigma.telkomstorage.R.drawable.ic_user;
                        if (userName.equals(shareWith)) {
                            displayName = getContext().getString(com.telkomsigma.telkomstorage.R.string.share_remote_clarification, userName);
                        } else {
                            String[] uriSplitted = shareWith.split("@");
                            displayName = getContext().getString(com.telkomsigma.telkomstorage.R.string.share_known_remote_clarification, userName,
