 ...
 */
package com.telkomsigma.telkomstorage.media;
...
public class MediaControlView extends FrameLayout /* implements OnLayoutChangeListener, OnTouchListener */ implements OnClickListener, OnSeekBarChangeListener {
    ...
    public MediaControlView(Context context, AttributeSet attrs) {
        ...
        mRoot = inflate.inflate(com.telkomsigma.telkomstorage.R.layout.media_control, null);
    ...
    */
    ...
    private void initControllerView(View v) {
        mPauseButton = v.findViewById(com.telkomsigma.telkomstorage.R.id.playBtn);
        if (mPauseButton != null) {
            mPauseButton.requestFocus();
            mPauseButton.setOnClickListener(this);
        }

        mFfwdButton = v.findViewById(com.telkomsigma.telkomstorage.R.id.forwardBtn);
        if (mFfwdButton != null) {
            mFfwdButton.setOnClickListener(this);
        }

        mRewButton = v.findViewById(com.telkomsigma.telkomstorage.R.id.rewindBtn);
        if (mRewButton != null) {
            mRewButton.setOnClickListener(this);
        }

        mProgress = v.findViewById(com.telkomsigma.telkomstorage.R.id.progressBar);
        if (mProgress != null) {
        ...
        mEndTime = v.findViewById(com.telkomsigma.telkomstorage.R.id.totalTimeText);
        mCurrentTime = v.findViewById(com.telkomsigma.telkomstorage.R.id.currentTimeText);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case com.telkomsigma.telkomstorage.R.id.playBtn:
                doPauseResume();
                break;

            case com.telkomsigma.telkomstorage.R.id.rewindBtn:
            ...
            case com.telkomsigma.telkomstorage.R.id.forwardBtn:
                pos = mPlayer.getCurrentPosition();
                pos += 15000;
                mPlayer.seekTo(pos);
                if (!playing) {
