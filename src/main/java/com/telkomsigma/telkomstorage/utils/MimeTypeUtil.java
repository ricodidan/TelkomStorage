...
public class MimeTypeUtil {
    ...
    public static Drawable getFileTypeIcon(String mimetype, String filename, Account account) {
        ...
        if (com.telkomsigma.telkomstorage.R.drawable.file_zip == iconId) {
    ...
    public static Drawable getFolderTypeIcon(boolean isSharedViaUsers, boolean isSharedViaLink, Account account) {
        ...
        if (isSharedViaLink) {
            drawableId = com.telkomsigma.telkomstorage.R.drawable.folder_public;
        } else if (isSharedViaUsers) {
            drawableId = com.telkomsigma.telkomstorage.R.drawable.shared_with_me_folder;
        } else {
            drawableId = com.telkomsigma.telkomstorage.R.drawable.folder;
        }
    ...
    private static int determineIconIdByMimeTypeList(List<String> mimetypes) {
        ...
        if (mimetypes == null || mimetypes.size() < 1) {
            return com.telkomsigma.telkomstorage.R.drawable.file;
        } else {
    ...
    private static void populateMimeTypeIconMapping() {
        MIMETYPE_TO_ICON_MAPPING.put("application/coreldraw", com.telkomsigma.telkomstorage.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/epub+zip", com.telkomsigma.telkomstorage.R.drawable.file_text);
        MIMETYPE_TO_ICON_MAPPING.put("application/font-sfnt", com.telkomsigma.telkomstorage.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/font-woff", com.telkomsigma.telkomstorage.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/illustrator", com.telkomsigma.telkomstorage.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/javascript", com.telkomsigma.telkomstorage.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("application/json", com.telkomsigma.telkomstorage.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("application/msaccess", com.telkomsigma.telkomstorage.R.drawable.file);
        MIMETYPE_TO_ICON_MAPPING.put("application/msexcel", com.telkomsigma.telkomstorage.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/mspowerpoint", com.telkomsigma.telkomstorage.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/msword", com.telkomsigma.telkomstorage.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/octet-stream", com.telkomsigma.telkomstorage.R.drawable.file);
        MIMETYPE_TO_ICON_MAPPING.put("application/postscript", com.telkomsigma.telkomstorage.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/pdf", com.telkomsigma.telkomstorage.R.drawable.file_pdf);
        MIMETYPE_TO_ICON_MAPPING.put("application/rss+xml", com.telkomsigma.telkomstorage.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("application/rtf", com.telkomsigma.telkomstorage.R.drawable.file);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.android.package-archive", com.telkomsigma.telkomstorage.R.drawable.file_zip);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-excel", com.telkomsigma.telkomstorage.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-excel.addin.macroEnabled.12", com.telkomsigma.telkomstorage.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-excel.sheet.binary.macroEnabled.12", com.telkomsigma.telkomstorage.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-excel.sheet.macroEnabled.12", com.telkomsigma.telkomstorage.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-excel.template.macroEnabled.12", com.telkomsigma.telkomstorage.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-fontobject", com.telkomsigma.telkomstorage.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-powerpoint", com.telkomsigma.telkomstorage.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-powerpoint.addin.macroEnabled.12", com.telkomsigma.telkomstorage.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-powerpoint.presentation.macroEnabled.12", com.telkomsigma.telkomstorage.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-powerpoint.slideshow.macroEnabled.12", com.telkomsigma.telkomstorage.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-powerpoint.template.macroEnabled.12", com.telkomsigma.telkomstorage.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-word.document.macroEnabled.12", com.telkomsigma.telkomstorage.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.ms-word.template.macroEnabled.12", com.telkomsigma.telkomstorage.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.oasis.opendocument.presentation", com.telkomsigma.telkomstorage.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.oasis.opendocument.presentation-template", com.telkomsigma.telkomstorage.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.oasis.opendocument.spreadsheet", com.telkomsigma.telkomstorage.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.oasis.opendocument.spreadsheet-template", com.telkomsigma.telkomstorage.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.oasis.opendocument.text", com.telkomsigma.telkomstorage.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.oasis.opendocument.text-master", com.telkomsigma.telkomstorage.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.oasis.opendocument.text-template", com.telkomsigma.telkomstorage.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.oasis.opendocument.text-web", com.telkomsigma.telkomstorage.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.openxmlformats-officedocument.presentationml.presentation", com.telkomsigma.telkomstorage.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.openxmlformats-officedocument.presentationml.slideshow", com.telkomsigma.telkomstorage.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.openxmlformats-officedocument.presentationml.template", com.telkomsigma.telkomstorage.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", com.telkomsigma.telkomstorage.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.openxmlformats-officedocument.spreadsheetml.template", com.telkomsigma.telkomstorage.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.openxmlformats-officedocument.wordprocessingml.document", com.telkomsigma.telkomstorage.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/vnd.openxmlformats-officedocument.wordprocessingml.template", com.telkomsigma.telkomstorage.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-7z-compressed", com.telkomsigma.telkomstorage.R.drawable.file_zip);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-bin", com.telkomsigma.telkomstorage.R.drawable.file_application);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-cbr", com.telkomsigma.telkomstorage.R.drawable.file_text);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-compressed", com.telkomsigma.telkomstorage.R.drawable.file_zip);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-dcraw", com.telkomsigma.telkomstorage.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-deb", com.telkomsigma.telkomstorage.R.drawable.file_zip);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-font", com.telkomsigma.telkomstorage.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-gimp", com.telkomsigma.telkomstorage.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-gzip", com.telkomsigma.telkomstorage.R.drawable.file_zip);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-ms-dos-executable", com.telkomsigma.telkomstorage.R.drawable.file_application);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-msi", com.telkomsigma.telkomstorage.R.drawable.file_application);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-iwork-numbers-sffnumbers", com.telkomsigma.telkomstorage.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-iwork-keynote-sffkey", com.telkomsigma.telkomstorage.R.drawable.file_ppt);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-iwork-pages-sffpages", com.telkomsigma.telkomstorage.R.drawable.file_doc);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-perl", com.telkomsigma.telkomstorage.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-photoshop", com.telkomsigma.telkomstorage.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-php", com.telkomsigma.telkomstorage.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-rar-compressed", com.telkomsigma.telkomstorage.R.drawable.file_zip);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-shockwave-flash", com.telkomsigma.telkomstorage.R.drawable.file_application);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-tar", com.telkomsigma.telkomstorage.R.drawable.file_zip);
        MIMETYPE_TO_ICON_MAPPING.put("application/x-tex", com.telkomsigma.telkomstorage.R.drawable.file_text);
        MIMETYPE_TO_ICON_MAPPING.put("application/xml", com.telkomsigma.telkomstorage.R.drawable.file_text);
        MIMETYPE_TO_ICON_MAPPING.put("application/yaml", com.telkomsigma.telkomstorage.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("application/zip", com.telkomsigma.telkomstorage.R.drawable.file_zip);
        MIMETYPE_TO_ICON_MAPPING.put("database", com.telkomsigma.telkomstorage.R.drawable.file);
        MIMETYPE_TO_ICON_MAPPING.put("httpd/unix-directory", com.telkomsigma.telkomstorage.R.drawable.folder);
        MIMETYPE_TO_ICON_MAPPING.put("image/svg+xml", com.telkomsigma.telkomstorage.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("image/vector", com.telkomsigma.telkomstorage.R.drawable.file_image);
        MIMETYPE_TO_ICON_MAPPING.put("text/calendar", com.telkomsigma.telkomstorage.R.drawable.file_calendar);
        MIMETYPE_TO_ICON_MAPPING.put("text/css", com.telkomsigma.telkomstorage.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("text/csv", com.telkomsigma.telkomstorage.R.drawable.file_xls);
        MIMETYPE_TO_ICON_MAPPING.put("text/html", com.telkomsigma.telkomstorage.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("text/vcard", com.telkomsigma.telkomstorage.R.drawable.file_vcard);
        MIMETYPE_TO_ICON_MAPPING.put("text/x-c", com.telkomsigma.telkomstorage.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("text/x-c++src", com.telkomsigma.telkomstorage.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("text/x-h", com.telkomsigma.telkomstorage.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("text/x-python", com.telkomsigma.telkomstorage.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("text/x-shellscript", com.telkomsigma.telkomstorage.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put("web", com.telkomsigma.telkomstorage.R.drawable.file_code);
        MIMETYPE_TO_ICON_MAPPING.put(MimeType.DIRECTORY, com.telkomsigma.telkomstorage.R.drawable.folder);
    }
    ...
    private static void populateMainMimeTypeMapping() {
        MAIN_MIMETYPE_TO_ICON_MAPPING.put("audio", com.telkomsigma.telkomstorage.R.drawable.file_sound);
        MAIN_MIMETYPE_TO_ICON_MAPPING.put("database", com.telkomsigma.telkomstorage.R.drawable.file);
        MAIN_MIMETYPE_TO_ICON_MAPPING.put("httpd", com.telkomsigma.telkomstorage.R.drawable.file_zip);
        MAIN_MIMETYPE_TO_ICON_MAPPING.put("image", com.telkomsigma.telkomstorage.R.drawable.file_image);
        MAIN_MIMETYPE_TO_ICON_MAPPING.put("text", com.telkomsigma.telkomstorage.R.drawable.file_text);
        MAIN_MIMETYPE_TO_ICON_MAPPING.put("video", com.telkomsigma.telkomstorage.R.drawable.file_movie);
        MAIN_MIMETYPE_TO_ICON_MAPPING.put("web", com.telkomsigma.telkomstorage.R.drawable.file_code);
    }
