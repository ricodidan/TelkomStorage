...
public class ContactsBackupJob extends Job {
    ...
    protected Result onRunJob(Params params) {
        ...
        if (force || (lastExecution + 24 * 60 * 60 * 1000) < Calendar.getInstance().getTimeInMillis()) {
            ...
            String backupFolder = getContext().getResources().getString(com.telkomsigma.telkomstorage.R.string.contacts_backup_folder) +
                    OCFile.PATH_SEPARATOR;
            Integer daysToExpire = getContext().getResources().getInteger(com.telkomsigma.telkomstorage.R.integer.contacts_backup_expire);
