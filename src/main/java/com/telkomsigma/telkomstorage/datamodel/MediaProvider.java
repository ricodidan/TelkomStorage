    ...
    private static void checkPermissions(@Nullable Activity activity) {
        if (activity != null &&
            ...
            if (PermissionUtil.shouldShowRequestPermissionRationale(activity,
                ...
                Snackbar snackbar = Snackbar.make(activity.findViewById(com.telkomsigma.telkomstorage.R.id.ListLayout),
                        com.telkomsigma.telkomstorage.R.string.permission_storage_access, Snackbar.LENGTH_INDEFINITE)
