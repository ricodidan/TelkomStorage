...
package com.telkomsigma.telkomstorage.widgets;
...
public class ActionEditText extends AppCompatEditText {
    ...
    private void getAttrs(AttributeSet attr) {
        TypedArray a = getContext().obtainStyledAttributes(attr,
                com.telkomsigma.telkomstorage.R.styleable.ActionEditText);
        optionOneString = a
                .getString(com.telkomsigma.telkomstorage.R.styleable.ActionEditText_optionOneString);
        optionTwoString = a
                .getString(com.telkomsigma.telkomstorage.R.styleable.ActionEditText_optionTwoString);
        optionOneColor = a.getColor(com.telkomsigma.telkomstorage.R.styleable.ActionEditText_optionOneColor,
                0x00ff00);
        optionTwoColor = a.getColor(com.telkomsigma.telkomstorage.R.styleable.ActionEditText_optionTwoColor,
                0xff0000);
        badgeClickCallback = a
                .getString(com.telkomsigma.telkomstorage.R.styleable.ActionEditText_onBadgeClick);
    }
