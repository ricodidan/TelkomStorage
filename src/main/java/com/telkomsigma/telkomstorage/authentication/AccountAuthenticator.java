...
public class AccountAuthenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response,
        ...
        if (mContext.getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.multiaccount_support) || accounts.length < 1) {
            try {
            ...
            final String message = String.format(mContext.getString(com.telkomsigma.telkomstorage.R.string.auth_unsupported_multiaccount), mContext.getString(com.telkomsigma.telkomstorage.R.string.app_name));
