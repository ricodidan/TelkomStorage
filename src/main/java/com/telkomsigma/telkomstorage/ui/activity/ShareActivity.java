...
import com.telkomsigma.telkomstorage.operations.GetSharesForFileOperation;
...
import com.telkomsigma.telkomstorage.providers.UsersAndGroupsSearchProvider;
import com.telkomsigma.telkomstorage.ui.dialog.ShareLinkToDialog;
import com.telkomsigma.telkomstorage.ui.fragment.EditShareFragment;
import com.telkomsigma.telkomstorage.ui.fragment.SearchShareesFragment;
import com.telkomsigma.telkomstorage.ui.fragment.ShareFileFragment;
import com.telkomsigma.telkomstorage.ui.fragment.ShareFragmentListener;
import com.telkomsigma.telkomstorage.utils.ErrorMessageAdapter;
import com.telkomsigma.telkomstorage.utils.GetShareWithUsersAsyncTask;
...
public class ShareActivity extends FileActivity implements ShareFragmentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.telkomsigma.telkomstorage.R.layout.share_activity);
        ...
        if (savedInstanceState == null) {
            ...
            ft.replace(com.telkomsigma.telkomstorage.R.id.share_fragment_container, fragment, TAG_SHARE_FRAGMENT);
            ft.commit();
        }
    }
    ...
    private int getAppropiatePermissions(ShareType shareType) {
        ...
        if (getFile().isSharedWithMe()) {
            ...
            OwnCloudVersion serverVersion = com.telkomsigma.telkomstorage.authentication.AccountUtils.
    ...
    public void showSearchUsersAndGroups() {
        ...
        ft.replace(com.telkomsigma.telkomstorage.R.id.share_fragment_container, searchFragment, TAG_SEARCH_FRAGMENT);
    ...
    public void showEditShare(OCShare share) {
        ...
        ft.replace(com.telkomsigma.telkomstorage.R.id.share_fragment_container, editShareFragment, TAG_EDIT_SHARE_FRAGMENT);
    ...
    public void refreshUsersOrGroupsListFromServer() {
        // Show loading
        showLoadingDialog(getString(com.telkomsigma.telkomstorage.R.string.common_loading));
        ...
        if (result.isSuccess()) {
            ...
            if (username != null) {
                intentToShareLink.putExtra(
                        ...
                        getString(
                                com.telkomsigma.telkomstorage.R.string.subject_user_shared_with_you,
                                username,
                                getFile().getFileName()
                        )
                );
                ...
                intentToShareLink.putExtra(
                        Intent.EXTRA_SUBJECT,
                        getString(
                                com.telkomsigma.telkomstorage.R.string.subject_shared_with_you,
                                getFile().getFileName()
                        )
                );
            }
