...
import com.telkomsigma.telkomstorage.datamodel.VirtualFolderType;
...
import com.telkomsigma.telkomstorage.media.MediaService;
import com.telkomsigma.telkomstorage.media.MediaServiceBinder;
...
import com.telkomsigma.telkomstorage.ui.dialog.SendShareDialog;
import com.telkomsigma.telkomstorage.ui.dialog.SortingOrderDialogFragment;
import com.telkomsigma.telkomstorage.ui.events.SyncEventFinished;
import com.telkomsigma.telkomstorage.ui.events.TokenPushEvent;
import com.telkomsigma.telkomstorage.ui.fragment.ExtendedListFragment;
import com.telkomsigma.telkomstorage.ui.fragment.FileDetailFragment;
...
import com.telkomsigma.telkomstorage.ui.fragment.contactsbackup.ContactListFragment;
import com.telkomsigma.telkomstorage.ui.helpers.FileOperationsHelper;
...
import com.telkomsigma.telkomstorage.ui.preview.PreviewMediaFragment;
import com.telkomsigma.telkomstorage.ui.preview.PreviewTextFragment;
import com.telkomsigma.telkomstorage.ui.preview.PreviewVideoActivity;
...
import com.telkomsigma.telkomstorage.utils.PermissionUtil;
import com.telkomsigma.telkomstorage.utils.PushUtils;
...
public class FileDisplayActivity extends HookActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.telkomsigma.telkomstorage.R.layout.files);
...
//            setupDrawer(com.telkomsigma.telkomstorage.R.id.nav_on_device);
//        } else {
//            setupDrawer(com.telkomsigma.telkomstorage.R.id.nav_all_files);
//        }


        mDualPane = getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.large_land_layout);
        mLeftFragmentContainer = findViewById(com.telkomsigma.telkomstorage.R.id.left_fragment_container);
        mRightFragmentContainer = findViewById(com.telkomsigma.telkomstorage.R.id.right_fragment_container);
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        if (!PermissionUtil.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            if (PermissionUtil.shouldShowRequestPermissionRationale(this,
                ...
                Snackbar snackbar = Snackbar.make(findViewById(com.telkomsigma.telkomstorage.R.id.ListLayout), com.telkomsigma.telkomstorage.R.string.permission_storage_access,
                        Snackbar.LENGTH_INDEFINITE)
                        .setAction(com.telkomsigma.telkomstorage.R.string.common_ok, new View.OnClickListener() {
                            @Override
    ...
    private void upgradeNotificationForInstantUpload() {
        ...
        if (PreferenceManager.instantPictureUploadEnabled(this) ||
            ...
            // show info pop-up
            new AlertDialog.Builder(this, com.telkomsigma.telkomstorage.R.style.Theme_ownCloud_Dialog)
                    .setTitle(com.telkomsigma.telkomstorage.R.string.drawer_synced_folders)
                    .setMessage(com.telkomsigma.telkomstorage.R.string.synced_folders_new_info)
                    .setPositiveButton(com.telkomsigma.telkomstorage.R.string.drawer_open, new DialogInterface.OnClickListener() {
                    ...
                    .setNegativeButton(com.telkomsigma.telkomstorage.R.string.drawer_close, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
                        }
                    })
                    .setIcon(com.telkomsigma.telkomstorage.R.drawable.nav_synced_folders)
                    .show();
        }
    }
    ...
    private void switchToSearchFragment(Bundle savedInstanceState) {
        if (savedInstanceState == null) {
            ...
            transaction.add(com.telkomsigma.telkomstorage.R.id.left_fragment_container, listOfFiles, TAG_LIST_OF_FILES);
            transaction.commit();
        } else {
    ...
    private void setSecondFragment(Fragment fragment) {
        ...
        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
        transaction.replace(com.telkomsigma.telkomstorage.R.id.right_fragment_container, fragment, TAG_SECOND_FRAGMENT);
        transaction.commit();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(com.telkomsigma.telkomstorage.R.menu.main_menu, menu);
        menu.findItem(com.telkomsigma.telkomstorage.R.id.action_create_dir).setVisible(false);
        ...
        mDrawerMenuItemstoShowHideList.add(menu.findItem(com.telkomsigma.telkomstorage.R.id.action_sort));
        mDrawerMenuItemstoShowHideList.add(menu.findItem(com.telkomsigma.telkomstorage.R.id.action_sync_account));
        mDrawerMenuItemstoShowHideList.add(menu.findItem(com.telkomsigma.telkomstorage.R.id.action_switch_view));
        mDrawerMenuItemstoShowHideList.add(menu.findItem(com.telkomsigma.telkomstorage.R.id.action_search));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case com.telkomsigma.telkomstorage.R.id.action_sync_account: {
            ...
            case com.telkomsigma.telkomstorage.R.id.action_sort: {
                FragmentManager fm = getSupportFragmentManager();
                FragmentTransaction ft = fm.beginTransaction();
                ft.addToBackStack(null);

                SortingOrderDialogFragment mSortingOrderDialogFragment = SortingOrderDialogFragment.newInstance(
                        PreferenceManager.getSortOrder(this),
                        PreferenceManager.getSortAscending(this)
                );
                mSortingOrderDialogFragment.show(ft, SORT_ORDER_DIALOG_TAG);

                break;
            }
            case com.telkomsigma.telkomstorage.R.id.action_switch_view: {
                if (isGridView()) {
                    item.setTitle(getString(com.telkomsigma.telkomstorage.R.string.action_switch_grid_view));
                    item.setIcon(ContextCompat.getDrawable(getApplicationContext(),
                            com.telkomsigma.telkomstorage.R.drawable.ic_view_module));
                    getListOfFilesFragment().setListAsPreferred();
                } else {
                    item.setTitle(getApplicationContext().getString(com.telkomsigma.telkomstorage.R.string.action_switch_list_view));
                    item.setIcon(ContextCompat.getDrawable(getApplicationContext(),
                            com.telkomsigma.telkomstorage.R.drawable.ic_view_list));
                    getListOfFilesFragment().setGridAsPreferred();
                }
                break;
            }
            case com.telkomsigma.telkomstorage.R.id.action_select_all: {
    ...
    private void requestUploadOfFilesFromFileSystem(Intent data, int resultCode) {
        ...
        if (filePaths != null) {
            ...
            DisplayUtils.showSnackMessage(this, com.telkomsigma.telkomstorage.R.string.filedisplay_no_file_selected);
        }
    }
    ...
    private void revertBottomNavigationBarToAllFiles() {
        if (getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.bottom_toolbar_enabled)) {
            ...
            if (bottomNavigationView.getMenu().findItem(com.telkomsigma.telkomstorage.R.id.nav_bar_settings).isChecked()) {
                bottomNavigationView.getMenu().findItem(com.telkomsigma.telkomstorage.R.id.nav_bar_files).setChecked(true);
            }
        }
    }
    ...
    private void sendDownloadedFile(String packageName, String activityName) {
        if (mWaitingToSend != null) {
            ...
            // Show dialog
            String sendTitle = getString(com.telkomsigma.telkomstorage.R.string.activity_chooser_send_file_title);
            ...
            try {
                ...
                if (sameAccount && sameFile && detailFragmentIsShown) {
                    ...
                    if (renamedInUpload) {
                        ...
                        DisplayUtils.showSnackMessage(
                                getActivity(),
                                com.telkomsigma.telkomstorage.R.string.filedetails_renamed_in_upload_msg,
                                newName
                        );
                    }
