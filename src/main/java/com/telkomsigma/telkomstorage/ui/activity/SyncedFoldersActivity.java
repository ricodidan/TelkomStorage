...
import com.telkomsigma.telkomstorage.datamodel.MediaFolder;
import com.telkomsigma.telkomstorage.datamodel.MediaFolderType;
import com.telkomsigma.telkomstorage.datamodel.MediaProvider;
import com.telkomsigma.telkomstorage.datamodel.OCFile;
import com.telkomsigma.telkomstorage.datamodel.SyncedFolder;
import com.telkomsigma.telkomstorage.datamodel.SyncedFolderDisplayItem;
import com.telkomsigma.telkomstorage.datamodel.SyncedFolderProvider;
import com.telkomsigma.telkomstorage.files.services.FileUploader;
import com.telkomsigma.telkomstorage.ui.adapter.SyncedFolderAdapter;
import com.telkomsigma.telkomstorage.ui.decoration.MediaGridItemDecoration;
import com.telkomsigma.telkomstorage.ui.dialog.SyncedFolderPreferencesDialogFragment;
...
import com.telkomsigma.telkomstorage.utils.FilesSyncHelper;
...
public class SyncedFoldersActivity extends FileActivity implements SyncedFolderAdapter.ClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.telkomsigma.telkomstorage.R.layout.synced_folders_layout);

        // setup toolbar
        setupToolbar();
        CollapsingToolbarLayout mCollapsingToolbarLayout = findViewById(com.telkomsigma.telkomstorage.R.id.collapsing_toolbar);
        mCollapsingToolbarLayout.setTitle(this.getString(com.telkomsigma.telkomstorage.R.string.drawer_synced_folders));

        mCustomFolderRelativeLayout = findViewById(com.telkomsigma.telkomstorage.R.id.custom_folder_toolbar);

        SharedPreferences appPrefs =
                PreferenceManager.getDefaultSharedPreferences(getApplicationContext());


//        findViewById(com.telkomsigma.telkomstorage.R.id.toolbar).post(() -> {
//            if (!appPrefs.getBoolean(Preferences.PREFERENCE_EXPERT_MODE, false)) {
//                findViewById(com.telkomsigma.telkomstorage.R.id.app_bar).getLayoutParams().height = findViewById(com.telkomsigma.telkomstorage.R.id.toolbar).getHeight();
//
...
//                findViewById(com.telkomsigma.telkomstorage.R.id.app_bar).setBackgroundColor(getResources().getColor(com.telkomsigma.telkomstorage.R.color.filelist_icon_backgorund));
//            }
//        });


        // setup drawer
        //setupDrawer(com.telkomsigma.telkomstorage.R.id.nav_synced_folders);
        ...
        if (actionBar != null) {
            ThemeUtils.setColoredTitle(getSupportActionBar(), getString(com.telkomsigma.telkomstorage.R.string.drawer_synced_folders));
            actionBar.setDisplayHomeAsUpEnabled(true);
        }

        if (ThemeUtils.themingEnabled()) {
            setTheme(com.telkomsigma.telkomstorage.R.style.FallbackThemingTheme);
        }
    }
    ...
    private void setupContent() {
        ...
        final int gridWidth = getResources().getInteger(com.telkomsigma.telkomstorage.R.integer.media_grid_width);
        boolean lightVersion = getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.syncedFolder_light);
        ...
        int spacing = getResources().getDimensionPixelSize(com.telkomsigma.telkomstorage.R.dimen.media_grid_spacing);
        mRecyclerView.addItemDecoration(new MediaGridItemDecoration(spacing));
        mRecyclerView.setLayoutManager(lm);
        mRecyclerView.setAdapter(mAdapter);

        BottomNavigationView bottomNavigationView = findViewById(com.telkomsigma.telkomstorage.R.id.bottom_navigation_view);
    ...
    private SyncedFolderDisplayItem createSyncedFolderFromMediaFolder(@NonNull MediaFolder mediaFolder) {
        return new SyncedFolderDisplayItem(
                ...
                getString(com.telkomsigma.telkomstorage.R.string.instant_upload_path) + "/" + mediaFolder.folderName,
                true,
                false,
                false,
        ...
        switch (requestCode) {
            case PermissionUtil.PERMISSIONS_WRITE_EXTERNAL_STORAGE: {
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    int gridWidth = getResources().getInteger(com.telkomsigma.telkomstorage.R.integer.media_grid_width);
