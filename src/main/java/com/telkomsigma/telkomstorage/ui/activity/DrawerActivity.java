...
import com.telkomsigma.telkomstorage.datamodel.ArbitraryDataProvider;
import com.telkomsigma.telkomstorage.datamodel.ExternalLinksProvider;
import com.telkomsigma.telkomstorage.datamodel.OCFile;
import com.telkomsigma.telkomstorage.operations.GetCapabilitiesOperarion;
import com.telkomsigma.telkomstorage.ui.TextDrawable;
import com.telkomsigma.telkomstorage.ui.events.AccountRemovedEvent;
import com.telkomsigma.telkomstorage.ui.events.ChangeMenuEvent;
import com.telkomsigma.telkomstorage.ui.events.DummyDrawerEvent;
import com.telkomsigma.telkomstorage.ui.events.MenuItemClickEvent;
import com.telkomsigma.telkomstorage.ui.events.SearchEvent;
...
import com.telkomsigma.telkomstorage.utils.svg.MenuSimpleTarget;
...
public abstract class DrawerActivity extends ToolbarActivity implements DisplayUtils.AvatarGenerationListener {
    ...
    protected void setupDrawer() {
        mDrawerLayout = findViewById(com.telkomsigma.telkomstorage.R.id.drawer_layout);

        mNavigationView = findViewById(com.telkomsigma.telkomstorage.R.id.nav_view);
    ...
    private void setupDrawerToggle() {
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout, com.telkomsigma.telkomstorage.R.string.drawer_open, com.telkomsigma.telkomstorage.R.string.drawer_close) {
    ...
    private void setupDrawerHeader() {
        ...
        mAccountMiddleAccountAvatar = (ImageView) findNavigationViewChildById(com.telkomsigma.telkomstorage.R.id.drawer_account_middle);
        mAccountEndAccountAvatar = (ImageView) findNavigationViewChildById(com.telkomsigma.telkomstorage.R.id.drawer_account_end);

        mAccountChooserToggle = (ImageView) findNavigationViewChildById(com.telkomsigma.telkomstorage.R.id.drawer_account_chooser_toggle);
        mAccountChooserToggle.setColorFilter(ThemeUtils.fontColor());

        if (getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.allow_profile_click)) {
            mAccountChooserToggle.setImageResource(com.telkomsigma.telkomstorage.R.drawable.ic_down);

            findNavigationViewChildById(com.telkomsigma.telkomstorage.R.id.drawer_active_user)
    ...
    private void setupQuotaElement() {
        mQuotaView = (LinearLayout) findQuotaViewById(com.telkomsigma.telkomstorage.R.id.drawer_quota);
        mQuotaProgressBar = (ProgressBar) findQuotaViewById(com.telkomsigma.telkomstorage.R.id.drawer_quota_ProgressBar);
        mQuotaTextPercentage = (TextView) findQuotaViewById(com.telkomsigma.telkomstorage.R.id.drawer_quota_percentage);
        mQuotaTextLink = (TextView) findQuotaViewById(com.telkomsigma.telkomstorage.R.id.drawer_quota_link);
    ...
    protected void setupDrawerMenu(NavigationView navigationView) {
        ...
        if (mIsAccountChooserActive) {
            navigationView.getMenu().setGroupVisible(com.telkomsigma.telkomstorage.R.id.drawer_menu_accounts, true);
        } else {
            navigationView.getMenu().setGroupVisible(com.telkomsigma.telkomstorage.R.id.drawer_menu_accounts, false);
        }

        Account account = AccountUtils.getCurrentOwnCloudAccount(MainApp.getAppContext());
        boolean searchSupported = AccountUtils.hasSearchSupport(account);

        if (getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.bottom_toolbar_enabled) && account != null) {
            navigationView.getMenu().removeItem(com.telkomsigma.telkomstorage.R.id.nav_all_files);
            navigationView.getMenu().removeItem(com.telkomsigma.telkomstorage.R.id.nav_settings);
            navigationView.getMenu().removeItem(com.telkomsigma.telkomstorage.R.id.nav_favorites);
            navigationView.getMenu().removeItem(com.telkomsigma.telkomstorage.R.id.nav_photos);
        }

        if (!searchSupported && account != null) {
            navigationView.getMenu().removeItem(com.telkomsigma.telkomstorage.R.id.nav_photos);
            navigationView.getMenu().removeItem(com.telkomsigma.telkomstorage.R.id.nav_favorites);
            navigationView.getMenu().removeItem(com.telkomsigma.telkomstorage.R.id.nav_videos);
        }

        if (getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.use_home) && navigationView.getMenu().findItem(com.telkomsigma.telkomstorage.R.id.nav_all_files) !=
                null) {
            navigationView.getMenu().findItem(com.telkomsigma.telkomstorage.R.id.nav_all_files).setTitle(getResources().
                    getString(com.telkomsigma.telkomstorage.R.string.drawer_item_home));
            navigationView.getMenu().findItem(com.telkomsigma.telkomstorage.R.id.nav_all_files).setIcon(com.telkomsigma.telkomstorage.R.drawable.ic_home);
        }

//        if (!getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.participate_enabled)) {
//            navigationView.getMenu().removeItem(com.telkomsigma.telkomstorage.R.id.nav_participate);
//        }

        if (!getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.shared_enabled)) {
            navigationView.getMenu().removeItem(com.telkomsigma.telkomstorage.R.id.nav_shared);
        }

        if (!getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.contacts_backup)
                || !getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.show_drawer_contacts_backup)) {
            navigationView.getMenu().removeItem(com.telkomsigma.telkomstorage.R.id.nav_contacts);
        }

        /*if (getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.syncedFolder_light)) {
            navigationView.getMenu().removeItem(com.telkomsigma.telkomstorage.R.id.nav_synced_folders);
        }*/

        if (!getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.show_drawer_logout)) {
            navigationView.getMenu().removeItem(com.telkomsigma.telkomstorage.R.id.nav_logout);
        }

        if (AccountUtils.hasSearchSupport(account)) {
            if (!getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.recently_added_enabled)) {
                navigationView.getMenu().removeItem(com.telkomsigma.telkomstorage.R.id.nav_recently_added);
            }

            if (!getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.recently_modified_enabled)) {
                navigationView.getMenu().removeItem(com.telkomsigma.telkomstorage.R.id.nav_recently_modified);
            }

            if (!getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.videos_enabled)) {
                navigationView.getMenu().removeItem(com.telkomsigma.telkomstorage.R.id.nav_videos);
            }
    ...
    public void onMessageEvent(MenuItemClickEvent event) {
        ...
        switch (event.menuItem.getItemId()) {
            case com.telkomsigma.telkomstorage.R.id.nav_bar_files:
                showFiles(false);
                break;
            case com.telkomsigma.telkomstorage.R.id.nav_bar_settings:
...
//                break;
            ...
            if (persistingAccounts.size() > 0) {
                ...
                if (mAvatars[1] != null) {
                    DisplayUtils.setAvatar(mAvatars[1], this,
                            ...
                            findNavigationViewChildById(com.telkomsigma.telkomstorage.R.id.drawer_account_end));
                ...
                if (mAvatars[2] != null) {
                    DisplayUtils.setAvatar(mAvatars[2], this,
                            mOtherAccountAvatarRadiusDimension, getResources(), getStorageManager(),
                            findNavigationViewChildById(com.telkomsigma.telkomstorage.R.id.drawer_account_middle));
    ...
    private void repopulateAccountList(ArrayList<Account> accounts) {
        ...
        mNavigationView.getMenu().removeGroup(com.telkomsigma.telkomstorage.R.id.drawer_menu_accounts);
        ...
        for (Account account : accounts) {
            try {
                ...
                if (!getAccount().name.equals(account.name)) {
                    String mntp, mntp1;
                    if (account.name.contains("@telkomstorage")) {
                        mntp = account.name.substring(0, account.name.indexOf("@"));
                        mntp1 = mntp + "@telkommail.id";
                    } else {
                        mntp1 = account.name;
                    }

                    MenuItem accountMenuItem = mNavigationView.getMenu().add(
                            com.telkomsigma.telkomstorage.R.id.drawer_menu_accounts,
                            Menu.NONE,
                            MENU_ORDER_ACCOUNT,
                            account.name)
                ...
                mNavigationView.getMenu().add(
                        ...
                        MENU_ORDER_ACCOUNT,
                        account.name)
                        .setIcon(com.telkomsigma.telkomstorage.R.drawable.ic_user);
            }
        }

        // re-add add-account and manage-accounts
        mNavigationView.getMenu().add(com.telkomsigma.telkomstorage.R.id.drawer_menu_accounts, com.telkomsigma.telkomstorage.R.id.drawer_menu_account_add,
                MENU_ORDER_ACCOUNT_FUNCTION,
                getResources().getString(com.telkomsigma.telkomstorage.R.string.prefs_add_account)).setIcon(com.telkomsigma.telkomstorage.R.drawable.ic_account_plus);
        mNavigationView.getMenu().add(com.telkomsigma.telkomstorage.R.id.drawer_menu_accounts, com.telkomsigma.telkomstorage.R.id.drawer_menu_account_manage,
                MENU_ORDER_ACCOUNT_FUNCTION,
                getResources().getString(com.telkomsigma.telkomstorage.R.string.drawer_manage_accounts)).setIcon(com.telkomsigma.telkomstorage.R.drawable.ic_settings);
    ...
    protected void setAccountInDrawer(Account account) {
        if (mDrawerLayout != null && account != null) {
            TextView username = (TextView) findNavigationViewChildById(com.telkomsigma.telkomstorage.R.id.drawer_username);
            TextView usernameFull = (TextView) findNavigationViewChildById(com.telkomsigma.telkomstorage.R.id.drawer_username_full);
            if (account.name.contains("@telkomstorage")) {
                String coba = account.name.substring(0, account.name.indexOf("@"));
                usernameFull.setText(coba + "@telkommail.id");
                Log.d("EMAILL", coba);
            } else {
            ...
            try {
                ...
                if (oca.getDisplayName().contains("@telkommail")) {
                    String coba1 = oca.getDisplayName().substring(0, oca.getDisplayName().indexOf("@"));
                    username.setText(coba1);
                } else {
            ...
            DisplayUtils.setAvatar(account, this,
                    ...
                    findNavigationViewChildById(com.telkomsigma.telkomstorage.R.id.drawer_current_account));
        ...
        if (mNavigationView != null) {
            if (mIsAccountChooserActive) {
                if (mAccountChooserToggle != null) {
                    mAccountChooserToggle.setImageResource(com.telkomsigma.telkomstorage.R.drawable.ic_up);
                }
                mNavigationView.getMenu().setGroupVisible(com.telkomsigma.telkomstorage.R.id.drawer_menu_accounts, true);

                if (!getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.multiaccount_support) &&
                        mNavigationView.getMenu().findItem(com.telkomsigma.telkomstorage.R.id.drawer_menu_account_add) != null) {
                    mNavigationView.getMenu().removeItem(com.telkomsigma.telkomstorage.R.id.drawer_menu_account_add);
                }

                mNavigationView.getMenu().setGroupVisible(com.telkomsigma.telkomstorage.R.id.drawer_menu_standard, false);
                mNavigationView.getMenu().setGroupVisible(com.telkomsigma.telkomstorage.R.id.drawer_menu_external_links, false);
                mNavigationView.getMenu().setGroupVisible(com.telkomsigma.telkomstorage.R.id.drawer_menu_bottom, false);
            } else {
                if (mAccountChooserToggle != null) {
                    mAccountChooserToggle.setImageResource(com.telkomsigma.telkomstorage.R.drawable.ic_down);
                }
                mNavigationView.getMenu().setGroupVisible(com.telkomsigma.telkomstorage.R.id.drawer_menu_accounts, false);
                mNavigationView.getMenu().setGroupVisible(com.telkomsigma.telkomstorage.R.id.drawer_menu_standard, true);
                mNavigationView.getMenu().setGroupVisible(com.telkomsigma.telkomstorage.R.id.drawer_menu_external_links, true);
                mNavigationView.getMenu().setGroupVisible(com.telkomsigma.telkomstorage.R.id.drawer_menu_bottom, true);
            }
        }
    }
    ...
    private void setQuotaInformation(long usedSpace, long totalSpace, int relative) {
        ...
        mQuotaTextPercentage.setText(String.format(
                getString(com.telkomsigma.telkomstorage.R.string.drawer_quota),
    ...
    private void updateQuotaLink() {
        if (mQuotaTextLink != null) {
            if (getBaseContext().getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.show_external_links)) {
                ...
                if (quotas.size() > 0) {
                    ...
                    DisplayUtils.downloadIcon(this, firstQuota.iconUrl, target, com.telkomsigma.telkomstorage.R.drawable.ic_link_grey, size, size);
    ...
    public void updateExternalLinksInDrawer() {
        if (mNavigationView != null && getBaseContext().getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.show_external_links)) {
            mNavigationView.getMenu().removeGroup(com.telkomsigma.telkomstorage.R.id.drawer_menu_external_links);

            float density = getResources().getDisplayMetrics().density;
            final int size = Math.round(24 * density);
            int greyColor = getResources().getColor(com.telkomsigma.telkomstorage.R.color.standard_grey);

            for (final ExternalLink link : externalLinksProvider.getExternalLink(ExternalLinkType.LINK)) {
                int id = mNavigationView.getMenu().add(com.telkomsigma.telkomstorage.R.id.drawer_menu_external_links,
                ...
                DisplayUtils.downloadIcon(this, link.iconUrl, target, com.telkomsigma.telkomstorage.R.drawable.ic_link_grey, size, size);
            }
        }
    }
    ...
    public void updateHeaderBackground() {
        if (getAccount() != null &&
            ...
            final LinearLayout navigationHeader = (LinearLayout) findNavigationViewChildById(com.telkomsigma.telkomstorage.R.id.drawer_header_view);
            ...
            if (navigationHeader != null) {
                ...
                if (URLUtil.isValidUrl(background) || background.isEmpty()) {
                    ...
                    SimpleTarget target = new SimpleTarget<Drawable>() {
                        ...
                        public void onLoadFailed(Exception e, Drawable errorDrawable) {
                            Drawable[] drawables = {new ColorDrawable(primaryColor),
                                    getResources().getDrawable(com.telkomsigma.telkomstorage.R.drawable.bg_awal)};
                            LayerDrawable layerDrawable = new LayerDrawable(drawables);
                    ...
                    Glide.with(this)
                            .load(background)
                            .centerCrop()
                            .placeholder(com.telkomsigma.telkomstorage.R.drawable.bg_awal)
                            .error(com.telkomsigma.telkomstorage.R.drawable.bg_awal)
                            .crossFade()
                            .into(target);
                } else {
                    // plain color
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCurrentAccountAvatarRadiusDimension = getResources()
                .getDimension(com.telkomsigma.telkomstorage.R.dimen.nav_drawer_header_avatar_radius);
        mOtherAccountAvatarRadiusDimension = getResources()
                .getDimension(com.telkomsigma.telkomstorage.R.dimen.nav_drawer_header_avatar_other_accounts_radius);
        mMenuAccountAvatarRadiusDimension = getResources()
                .getDimension(com.telkomsigma.telkomstorage.R.dimen.nav_drawer_menu_avatar_radius);
    ...
    private View findNavigationViewChildById(int id) {
        NavigationView view = findViewById(com.telkomsigma.telkomstorage.R.id.nav_view);
    ...
    private View findQuotaViewById(int id) {
        View v = ((NavigationView) findViewById(com.telkomsigma.telkomstorage.R.id.nav_view)).getHeaderView(0).findViewById(id);
