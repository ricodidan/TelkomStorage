...
public abstract class ToolbarActivity extends BaseActivity {
    ...
    protected void setupToolbar(boolean useBackgroundImage) {
        ...
        mProgressBar = findViewById(com.telkomsigma.telkomstorage.R.id.progressBar);
        if (mProgressBar != null) {
            mProgressBar.setIndeterminateDrawable(
                    ContextCompat.getDrawable(this, com.telkomsigma.telkomstorage.R.drawable.actionbar_progress_indeterminate_horizontal));
    ...
    protected void updateActionBarTitleAndHomeButtonByString(String title) {
        String titleToSet = getString(com.telkomsigma.telkomstorage.R.string.app_name);    // default
