...
import com.telkomsigma.telkomstorage.jobs.FilesSyncJob;
import com.telkomsigma.telkomstorage.operations.CheckCurrentCredentialsOperation;
import com.telkomsigma.telkomstorage.ui.fragment.UploadListFragment;
...
public class UploadListActivity extends FileActivity implements UploadListFragment.ContainerActivity {
    ...
    private static final String SCREEN_NAME = "History uploads";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.telkomsigma.telkomstorage.R.layout.upload_list_layout);
        ...
        // setup drawer
        setupDrawer(com.telkomsigma.telkomstorage.R.id.nav_uploads);
        ...
        getSupportActionBar().setTitle(getString(com.telkomsigma.telkomstorage.R.string.uploads_view_title));
    ...
    private void createUploadListFragment() {
        ...
        transaction.add(com.telkomsigma.telkomstorage.R.id.upload_list_fragment, uploadList, TAG_UPLOAD_LIST_FRAGMENT);
        transaction.commit();
    }
    ...
    public boolean onUploadItemClick(OCUpload file) {
        ...
        if (!f.exists()) {
            DisplayUtils.showSnackMessage(this, com.telkomsigma.telkomstorage.R.string.local_file_not_found_toast);
        } else {
    ...
    private void openFileWithDefault(String localPath) {
        ...
        try {
            ...
            DisplayUtils.showSnackMessage(this, com.telkomsigma.telkomstorage.R.string.file_list_no_app_for_file_type);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case com.telkomsigma.telkomstorage.R.id.action_retry_uploads:
                FileUploader.UploadRequester requester = new FileUploader.UploadRequester();
                requester.retryFailedUploads(this, null, null);
                if (mMenu != null) {
                    mMenu.removeItem(com.telkomsigma.telkomstorage.R.id.action_retry_uploads);
                }
                break;

            case com.telkomsigma.telkomstorage.R.id.action_clear_failed_uploads:
            ...
            case com.telkomsigma.telkomstorage.R.id.action_clear_successfull_uploads:
                storageManager = new UploadsStorageManager(getContentResolver(), getApplicationContext());
                storageManager.clearSuccessfulUploads();
                uploadListFragment.updateUploads();
                break;

            case com.telkomsigma.telkomstorage.R.id.action_force_rescan:
                ...
                if (mMenu != null) {
                    mMenu.removeItem(com.telkomsigma.telkomstorage.R.id.action_force_rescan);
                }
...
//            inflater.inflate(com.telkomsigma.telkomstorage.R.menu.upload_list_menu, menu);
//            mMenu = menu;
//        }
//
//        return true;
//    }
    ...
    protected String getDefaultTitle() {
        return getString(com.telkomsigma.telkomstorage.R.string.uploads_view_title);
    }
