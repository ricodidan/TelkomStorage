...
public class FingerprintActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.telkomsigma.telkomstorage.R.layout.fingerprintlock);

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ThemeUtils.primaryDarkColor());
        }

        Toolbar toolbar = findViewById(com.telkomsigma.telkomstorage.R.id.toolbar);
        toolbar.setTitleTextColor(ThemeUtils.fontColor());
        toolbar.setBackground(new ColorDrawable(ThemeUtils.primaryColor()));
    }

    private void startFingerprint() {
        TextView fingerprintTextView = findViewById(com.telkomsigma.telkomstorage.R.id.scanfingerprinttext);
            ...
            if (cipherInit()) {
                ...
                FingerprintHandler.Callback callback = new FingerprintHandler.Callback() {
                    ...
                    public void onFailed(String error) {
                        ...
                        ImageView imageView = findViewById(com.telkomsigma.telkomstorage.R.id.fingerprinticon);
                        int[][] states = new int[][]{
    ...
    public void onResume() {
        ...
        startFingerprint();
        ImageView imageView = findViewById(com.telkomsigma.telkomstorage.R.id.fingerprinticon);
        imageView.setImageDrawable(ThemeUtils.tintDrawable(com.telkomsigma.telkomstorage.R.drawable.ic_fingerprint, ThemeUtils.primaryColor()));
    }
    ...
    private void fingerprintResult(boolean fingerOk) {
        if (fingerOk) {
            ...
            showErrorAndRestart(com.telkomsigma.telkomstorage.R.string.fingerprint_unknown);
        }
    }
...
class FingerprintHandler extends FingerprintManager.AuthenticationCallback {
    ...
    public void onAuthenticationFailed() {
        this.update(MainApp.getAppContext().getString(com.telkomsigma.telkomstorage.R.string.fingerprint_unknown), false);
    }
