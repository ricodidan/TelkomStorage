...
import com.telkomsigma.telkomstorage.authentication.AuthenticatorActivity;
import com.telkomsigma.telkomstorage.datamodel.ArbitraryDataProvider;
import com.telkomsigma.telkomstorage.datamodel.PushConfigurationState;
...
public class UserInfoActivity extends FileActivity {
    ...
    @BindView(com.telkomsigma.telkomstorage.R.id.user_info_view)
    public LinearLayout userInfoView;

    @BindView(com.telkomsigma.telkomstorage.R.id.user_icon)
    public ImageView avatar;

    @BindView(com.telkomsigma.telkomstorage.R.id.drawer_username)
    public TextView userName;

    @BindView(com.telkomsigma.telkomstorage.R.id.drawer_username_full)
    public TextView fullName;

    @BindView(com.telkomsigma.telkomstorage.R.id.phone_container)
    public View mPhoneNumberContainer;

    @BindView(com.telkomsigma.telkomstorage.R.id.phone_number)
    public TextView mPhoneNumberTextView;

    @BindView(com.telkomsigma.telkomstorage.R.id.phone_icon)
    public ImageView mPhoneNumberIcon;

    @BindView(com.telkomsigma.telkomstorage.R.id.email_container)
    public View mEmailContainer;

    @BindView(com.telkomsigma.telkomstorage.R.id.email_address)
    public TextView mEmailAddressTextView;

    @BindView(com.telkomsigma.telkomstorage.R.id.email_icon)
    public ImageView mEmailIcon;

    @BindView(com.telkomsigma.telkomstorage.R.id.address_container)
    public View mAddressContainer;

    @BindView(com.telkomsigma.telkomstorage.R.id.address)
    public TextView mAddressTextView;

    @BindView(com.telkomsigma.telkomstorage.R.id.address_icon)
    public ImageView mAddressIcon;

    @BindView(com.telkomsigma.telkomstorage.R.id.website_container)
    public View mWebsiteContainer;

    @BindView(com.telkomsigma.telkomstorage.R.id.website_address)
    public TextView mWebsiteTextView;

    @BindView(com.telkomsigma.telkomstorage.R.id.website_icon)
    public ImageView mWebsiteIcon;

    @BindView(com.telkomsigma.telkomstorage.R.id.twitter_container)
    public View mTwitterContainer;

    @BindView(com.telkomsigma.telkomstorage.R.id.twitter_handle)
    public TextView mTwitterHandleTextView;

    @BindView(com.telkomsigma.telkomstorage.R.id.twitter_icon)
    ...
    @BindString(com.telkomsigma.telkomstorage.R.string.user_information_retrieval_error)
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCurrentAccountAvatarRadiusDimension = getResources().getDimension(com.telkomsigma.telkomstorage.R.dimen.nav_drawer_header_avatar_radius);

        setContentView(com.telkomsigma.telkomstorage.R.layout.user_info_layout);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(com.telkomsigma.telkomstorage.R.menu.user_info_menu, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                onBackPressed();
                break;
            case com.telkomsigma.telkomstorage.R.id.change_password:
                changeAccountPassword(account);
                break;
            case com.telkomsigma.telkomstorage.R.id.delete_account:
    ...
    private void setErrorMessageForMultiList(String headline, String message) {
        if (emptyContentContainer != null && emptyContentMessage != null) {
            ...
            emptyContentIcon.setImageResource(com.telkomsigma.telkomstorage.R.drawable.ic_list_empty_error);
    ...
    private void setHeaderImage() {
        if (getStorageManager().getCapability(account.name).getServerBackground() != null) {
            final AppBarLayout appBar = findViewById(com.telkomsigma.telkomstorage.R.id.appbar);
    ...
    public static class AccountRemovalConfirmationDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity(), com.telkomsigma.telkomstorage.R.style.Theme_ownCloud_Dialog)
                    .setTitle(com.telkomsigma.telkomstorage.R.string.delete_account)
                    .setMessage(getResources().getString(com.telkomsigma.telkomstorage.R.string.delete_account_warning, account.name))
                    .setIcon(com.telkomsigma.telkomstorage.R.drawable.ic_warning)
                    .setPositiveButton(com.telkomsigma.telkomstorage.R.string.common_ok,
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    if (!TextUtils.isEmpty(arbitraryDataPushString = arbitraryDataProvider.getValue(
                                            ...
                                            !TextUtils.isEmpty(getResources().getString(com.telkomsigma.telkomstorage.R.string.push_server_url))) {
                                        Gson gson = new Gson();
                    ...
                    .setNegativeButton(com.telkomsigma.telkomstorage.R.string.common_cancel, null)
                    .create();
        }
    }
}
