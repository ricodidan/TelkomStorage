...
package com.telkomsigma.telkomstorage.ui.whatsnew;
...
public class ProgressIndicator extends FrameLayout {
    ...
    public void setNumberOfSteps(int steps) {
        ...
        for (int i = 0; i < steps; ++i) {
            ...
            iv.setImageDrawable(getContext().getResources().getDrawable(com.telkomsigma.telkomstorage.R.drawable.whats_new_progress_transition));
