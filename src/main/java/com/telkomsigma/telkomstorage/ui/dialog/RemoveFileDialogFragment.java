...
public class RemoveFileDialogFragment extends ConfirmationDialogFragment
    ...
    public static RemoveFileDialogFragment newInstance(OCFile file) {
        ...
        int messageStringId = com.telkomsigma.telkomstorage.R.string.confirmation_remove_file_alert;

        int localRemoveButton = (!file.isAvailableOffline() && (file.isFolder() || file.isDown())) ?
                com.telkomsigma.telkomstorage.R.string.confirmation_remove_local : -1;

        if (file.isFolder()) {
            messageStringId = com.telkomsigma.telkomstorage.R.string.confirmation_remove_folder_alert;
        }
