...
public class CredentialsDialogFragment extends DialogFragment
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mUsernameET.setHint(getActivity().getText(com.telkomsigma.telkomstorage.R.string.auth_username));

        // Create field for password
        mPasswordET = new EditText(getActivity());
        mPasswordET.setHint(getActivity().getText(com.telkomsigma.telkomstorage.R.string.auth_password));
        ...
        Builder authDialog = new AlertDialog
                .Builder(getActivity())
                .setTitle(getActivity().getText(com.telkomsigma.telkomstorage.R.string.saml_authentication_required_text))
                .setView(ll)
                .setCancelable(false)
