...
public class SortingOrderDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mView = inflater.inflate(com.telkomsigma.telkomstorage.R.layout.sorting_order_fragment, container, false);
    ...
    private void setupDialogElements(View view) {
        ...
        mSortByNameAscendingButton = view.findViewById(com.telkomsigma.telkomstorage.R.id.sortByNameAscending);
        mSortByNameDescendingButton = view.findViewById(com.telkomsigma.telkomstorage.R.id.sortByNameDescending);
        mSortByModificationDateAscendingButton = view.findViewById(com.telkomsigma.telkomstorage.R.id.sortByModificationDateAscending);
        mSortByModificationDateDescendingButton = view.findViewById(com.telkomsigma.telkomstorage.R.id.sortByModificationDateDescending);
        mSortBySizeAscendingButton = view.findViewById(com.telkomsigma.telkomstorage.R.id.sortBySizeAscending);
        mSortBySizeDescendingButton = view.findViewById(com.telkomsigma.telkomstorage.R.id.sortBySizeDescending);
        mCancel = view.findViewById(com.telkomsigma.telkomstorage.R.id.cancel);
        mCancel.setTextColor(ThemeUtils.primaryAccentColor());

        mSortByNameAscendingText = view.findViewById(com.telkomsigma.telkomstorage.R.id.sortByNameAZText);
        mSortByNameDescendingText = view.findViewById(com.telkomsigma.telkomstorage.R.id.sortByNameZAText);
        mSortByModificationDateAscendingText = view.findViewById(com.telkomsigma.telkomstorage.R.id.sortByModificationDateOldestFirstText);
        mSortByModificationDateDescendingText = view.findViewById(com.telkomsigma.telkomstorage.R.id.sortByModificationDateNewestFirstText);
        mSortBySizeAscendingText = view.findViewById(com.telkomsigma.telkomstorage.R.id.sortBySizeSmallestFirstText);
        mSortBySizeDescendingText = view.findViewById(com.telkomsigma.telkomstorage.R.id.sortBySizeBiggestFirstText);
