    ...
    public static RemoveFilesDialogFragment newInstance(ArrayList<OCFile> files) {
        ...
        if (files.size() == 1) {
            ...
            messageStringId = (file.isFolder()) ?
                    com.telkomsigma.telkomstorage.R.string.confirmation_remove_folder_alert :
                    com.telkomsigma.telkomstorage.R.string.confirmation_remove_file_alert;

        } else {
            // choose message for more than one file
            messageStringId = (containsFolder) ?
                    com.telkomsigma.telkomstorage.R.string.confirmation_remove_folders_alert :
                    com.telkomsigma.telkomstorage.R.string.confirmation_remove_files_alert;

        }

        int localRemoveButton = (!containsFavorite && (containsFolder || containsDown)) ?
                com.telkomsigma.telkomstorage.R.string.confirmation_remove_local :
                -1;
        ...
        args.putInt(ARG_POSITIVE_BTN_RES, com.telkomsigma.telkomstorage.R.string.common_yes);
        args.putInt(ARG_NEUTRAL_BTN_RES, com.telkomsigma.telkomstorage.R.string.common_no);
