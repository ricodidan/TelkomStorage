...
public class UploadSourceDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String[] allTheItems = {
                getString(com.telkomsigma.telkomstorage.R.string.actionbar_upload_files),
                getString(com.telkomsigma.telkomstorage.R.string.actionbar_upload_from_apps)
        };

        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        builder.setTitle(com.telkomsigma.telkomstorage.R.string.actionbar_upload);
        builder.setItems(allTheItems, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int item) {
                if (item == 0) {
                    ...
                    getActivity().startActivityForResult(
                            Intent.createChooser(action, getString(com.telkomsigma.telkomstorage.R.string.upload_chooser_title)),
