...
public class SslValidatorDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mView = getLayoutInflater().inflate(com.telkomsigma.telkomstorage.R.layout.ssl_validator_layout, null);
        setContentView(mView);

        mView.findViewById(com.telkomsigma.telkomstorage.R.id.ok).setOnClickListener(
        ...
        mView.findViewById(com.telkomsigma.telkomstorage.R.id.cancel).setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        cancel();
        ...
        mView.findViewById(com.telkomsigma.telkomstorage.R.id.details_btn).setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        View detailsScroll = findViewById(com.telkomsigma.telkomstorage.R.id.details_scroll);
                        if (detailsScroll.getVisibility() == View.VISIBLE) {
                            detailsScroll.setVisibility(View.GONE);
                            ((Button) v).setText(com.telkomsigma.telkomstorage.R.string.ssl_validator_btn_details_see);
                        } else {
                            detailsScroll.setVisibility(View.VISIBLE);
                            ((Button) v).setText(com.telkomsigma.telkomstorage.R.string.ssl_validator_btn_details_hide);
                        }
                    }
                });
    }
    ...
    public void updateResult(RemoteOperationResult result) {
        if (result.isSslRecoverableException()) {
            ...
            /// clean
            mView.findViewById(com.telkomsigma.telkomstorage.R.id.reason_cert_not_trusted).setVisibility(View.GONE);
            mView.findViewById(com.telkomsigma.telkomstorage.R.id.reason_cert_expired).setVisibility(View.GONE);
            mView.findViewById(com.telkomsigma.telkomstorage.R.id.reason_cert_not_yet_valid).setVisibility(View.GONE);
            mView.findViewById(com.telkomsigma.telkomstorage.R.id.reason_hostname_not_verified).setVisibility(View.GONE);
            mView.findViewById(com.telkomsigma.telkomstorage.R.id.details_scroll).setVisibility(View.GONE);

            /// refresh
            if (mException.getCertPathValidatorException() != null) {
                mView.findViewById(com.telkomsigma.telkomstorage.R.id.reason_cert_not_trusted).setVisibility(View.VISIBLE);
            }

            if (mException.getCertificateExpiredException() != null) {
                mView.findViewById(com.telkomsigma.telkomstorage.R.id.reason_cert_expired).setVisibility(View.VISIBLE);
            }

            if (mException.getCertificateNotYetValidException() != null) {
                mView.findViewById(com.telkomsigma.telkomstorage.R.id.reason_cert_not_yet_valid).setVisibility(View.VISIBLE);
            }

            if (mException.getSslPeerUnverifiedException() != null) {
                mView.findViewById(com.telkomsigma.telkomstorage.R.id.reason_hostname_not_verified).setVisibility(View.VISIBLE);
            }
    ...
    private void showSignature(X509Certificate cert) {
        TextView sigView = mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_signature);
        TextView algorithmView = mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_signature_algorithm);
    ...
    private void showValidity(Date notBefore, Date notAfter) {
        TextView fromView = mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_validity_from);
        TextView toView = mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_validity_to);
    ...
    private void showSubject(X500Principal subject) {
        ...
        TextView cnView = mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_subject_CN);
        TextView oView = mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_subject_O);
        TextView ouView = mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_subject_OU);
        TextView cView = mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_subject_C);
        TextView stView = mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_subject_ST);
        TextView lView = mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_subject_L);
    ...
    private void showIssuer(X500Principal issuer) {
        ...
        TextView cnView = mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_issuer_CN);
        TextView oView = mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_issuer_O);
        TextView ouView = mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_issuer_OU);
        TextView cView = mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_issuer_C);
        TextView stView = mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_issuer_ST);
        TextView lView = mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_issuer_L);
