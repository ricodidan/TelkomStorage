...
import com.telkomsigma.telkomstorage.utils.glide.CustomGlideStreamLoader;
import com.telkomsigma.telkomstorage.utils.svg.SvgDecoder;
import com.telkomsigma.telkomstorage.utils.svg.SvgDrawableTranscoder;
import com.telkomsigma.telkomstorage.utils.svg.SvgSoftwareLayerSetter;
...
public class ActivityListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setActivityItems(List<Object> activityItems, OwnCloudClient client) {
        ...
        for (Object o : activityItems) {
            ...
            if (activity.getDatetime() != null) {
                ...
                time = context.getString(com.telkomsigma.telkomstorage.R.string.date_unknown);
            }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ACTIVITY_TYPE) {
            View v = LayoutInflater.from(parent.getContext()).inflate(com.telkomsigma.telkomstorage.R.layout.activity_list_item, parent, false);
            return new ActivityViewHolder(v);
        } else {
            View v = LayoutInflater.from(parent.getContext()).inflate(com.telkomsigma.telkomstorage.R.layout.activity_list_item_header, parent, false);
        ...
        if (!file.isFolder()) {
            if ((MimeTypeUtil.isImage(file) || MimeTypeUtil.isVideo(file))) {
                ...
                if (MimeTypeUtil.isImage(file)) {
                    placeholder = com.telkomsigma.telkomstorage.R.drawable.file_image;
                } else {
                    placeholder = com.telkomsigma.telkomstorage.R.drawable.file_movie;
                }
    ...
    private void downloadIcon(String icon, ImageView itemViewType) {
        GenericRequestBuilder<Uri, InputStream, SVG, PictureDrawable> requestBuilder = Glide.with(context)
                ...
                .placeholder(com.telkomsigma.telkomstorage.R.drawable.ic_activity)
                .error(com.telkomsigma.telkomstorage.R.drawable.ic_activity)
    ...
    private int getThumbnailDimension() {
        ...
        Double d = Math.pow(2, Math.floor(Math.log(r.getDimension(com.telkomsigma.telkomstorage.R.dimen.file_icon_size_grid)) / Math.log(2))) / 2;
        return d.intValue();
    }
    ...
    private class ActivityViewHolder extends RecyclerView.ViewHolder {
        ...
        private ActivityViewHolder(View itemView) {
            super(itemView);
            activityIcon = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.activity_icon);
            subject = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.activity_subject);
            message = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.activity_message);
            dateTime = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.activity_datetime);
            list = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.list);
        }
    }
    ...
    private class ActivityViewHeaderHolder extends RecyclerView.ViewHolder {
        ...
        private ActivityViewHeaderHolder(View itemView) {
            super(itemView);
            title = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.title_header);
