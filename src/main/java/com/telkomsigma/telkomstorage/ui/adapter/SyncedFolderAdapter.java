...
public class SyncedFolderAdapter extends SectionedRecyclerViewAdapter<SyncedFolderAdapter.MainViewHolder> {
    ...
    static class MainViewHolder extends RecyclerView.ViewHolder {
        ...
        private MainViewHolder(View itemView) {
            super(itemView);
            mainHeaderContainer = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.header_container);
            image = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.thumbnail);
            title = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.title);
            type = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.type);
            menuButton = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.settingsButton);
            syncStatusButton = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.syncStatusButton);
            counterBar = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.counterLayout);
            counterValue = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.counter);
            thumbnailDarkener = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.thumbnailDarkener);
        }
    }
}
