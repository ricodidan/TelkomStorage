...
import com.telkomsigma.telkomstorage.datamodel.UploadsStorageManager;
import com.telkomsigma.telkomstorage.db.OCUpload;
import com.telkomsigma.telkomstorage.db.UploadResult;
...
public class ExpandableUploadListAdapter extends BaseExpandableListAdapter implements Observer {
    ...
    public ExpandableUploadListAdapter(FileActivity parentActivity) {
        ...
        mUploadGroups[0] = new UploadGroup(mParentActivity.getString(com.telkomsigma.telkomstorage.R.string.uploads_view_group_current_uploads)) {
            @Override
            public void refresh() {
        ...
        mUploadGroups[1] = new UploadGroup(mParentActivity.getString(com.telkomsigma.telkomstorage.R.string.uploads_view_group_failed_uploads)) {
            @Override
            public void refresh() {
        ...
        mUploadGroups[2] = new UploadGroup(mParentActivity.getString(com.telkomsigma.telkomstorage.R.string.uploads_view_group_finished_uploads)) {
            @Override
            public void refresh() {
    ...
    private View getView(OCUpload[] uploadsItems, int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflator.inflate(com.telkomsigma.telkomstorage.R.layout.upload_list_item, parent, false);
        }
        ...
        if (uploadsItems != null && uploadsItems.length > position && uploadsItems[position] != null) {
            ...
            // local file name
            TextView fileTextView = view.findViewById(com.telkomsigma.telkomstorage.R.id.upload_name);
            ...
            TextView pathTextView = view.findViewById(com.telkomsigma.telkomstorage.R.id.upload_remote_path);
            String remoteParentPath = new File(upload.getRemotePath()).getParent();
            pathTextView.setText(remoteParentPath);

            // file size
            TextView fileSizeTextView = view.findViewById(com.telkomsigma.telkomstorage.R.id.upload_file_size);
            ...
            //* upload date
            TextView uploadDateTextView = view.findViewById(com.telkomsigma.telkomstorage.R.id.upload_date);
            ...
            TextView accountNameTextView = view.findViewById(com.telkomsigma.telkomstorage.R.id.upload_account);
            ...
            TextView statusTextView = view.findViewById(com.telkomsigma.telkomstorage.R.id.upload_status);

            ProgressBar progressBar = view.findViewById(com.telkomsigma.telkomstorage.R.id.upload_progress_bar);
            ...
            /// bind listeners to perform actions
            ImageButton rightButton = view.findViewById(com.telkomsigma.telkomstorage.R.id.upload_right_button);
            if (upload.getUploadStatus() == UploadsStorageManager.UploadStatus.UPLOAD_IN_PROGRESS) {
                //Cancel
                rightButton.setImageResource(com.telkomsigma.telkomstorage.R.drawable.ic_action_cancel_grey);
                ...
                //Delete
                rightButton.setImageResource(com.telkomsigma.telkomstorage.R.drawable.ic_action_delete_grey);
                rightButton.setVisibility(View.VISIBLE);
                rightButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ...
                        public void onClick(View v) {
                            ...
                            if (file.exists()) {
                                ...
                                Snackbar.make(
                                        ...
                                        mParentActivity.getString(com.telkomsigma.telkomstorage.R.string.local_file_not_found_toast),
            ...
            ImageView fileIcon = view.findViewById(com.telkomsigma.telkomstorage.R.id.thumbnail);
            fileIcon.setImageResource(com.telkomsigma.telkomstorage.R.drawable.file);
            ...
            if ((MimeTypeUtil.isImage(fakeFileToCheatThumbnailsCacheManagerInterface)
                ...
                if ("image/png".equals(upload.getMimeType())) {
                    fileIcon.setBackgroundColor(mParentActivity.getResources()
                            .getColor(com.telkomsigma.telkomstorage.R.color.background_color));
                }
    ...
    private String getStatusText(OCUpload upload) {
        ...
        switch (upload.getUploadStatus()) {
            ...
            case UPLOAD_IN_PROGRESS:
                status = mParentActivity.getString(com.telkomsigma.telkomstorage.R.string.uploads_view_later_waiting_to_upload);
                FileUploader.FileUploaderBinder binder = mParentActivity.getFileUploaderBinder();
                if (binder != null && binder.isUploadingNow(upload)) {
                    /// really uploading, bind the progress bar to listen for progress updates
                    status = mParentActivity.getString(com.telkomsigma.telkomstorage.R.string.uploader_upload_in_progress_ticker);
                }
                break;

            case UPLOAD_SUCCEEDED:
                status = mParentActivity.getString(com.telkomsigma.telkomstorage.R.string.uploads_view_upload_status_succeeded);
                break;
                ...
                switch (upload.getLastResult()) {
                    case CREDENTIAL_ERROR:
                        status = mParentActivity.getString(
                                com.telkomsigma.telkomstorage.R.string.uploads_view_upload_status_failed_credentials_error
                        );
                        break;
                    case FOLDER_ERROR:
                        status = mParentActivity.getString(
                                com.telkomsigma.telkomstorage.R.string.uploads_view_upload_status_failed_folder_error
                        );
                        break;
                    case FILE_NOT_FOUND:
                        status = mParentActivity.getString(
                                com.telkomsigma.telkomstorage.R.string.uploads_view_upload_status_failed_localfile_error
                        );
                        break;
                    case FILE_ERROR:
                        status = mParentActivity.getString(
                                com.telkomsigma.telkomstorage.R.string.uploads_view_upload_status_failed_file_error
                        );
                        break;
                    case PRIVILEDGES_ERROR:
                        status = mParentActivity.getString(
                                com.telkomsigma.telkomstorage.R.string.uploads_view_upload_status_failed_permission_error
                        );
                        break;
                    case NETWORK_CONNECTION:
                        status = mParentActivity.getString(
                                com.telkomsigma.telkomstorage.R.string.uploads_view_upload_status_failed_connection_error
                        );
                        break;
                    case DELAYED_FOR_WIFI:
                        status = mParentActivity.getString(
                                com.telkomsigma.telkomstorage.R.string.uploads_view_upload_status_waiting_for_wifi
                        );
                        break;
                    case DELAYED_FOR_CHARGING:
                        status = mParentActivity.getString(
                                com.telkomsigma.telkomstorage.R.string.uploads_view_upload_status_waiting_for_charging);
                        break;
                    case CONFLICT_ERROR:
                        status = mParentActivity.getString(
                                com.telkomsigma.telkomstorage.R.string.uploads_view_upload_status_conflict
                        );
                        break;
                    case SERVICE_INTERRUPTED:
                        status = mParentActivity.getString(
                                com.telkomsigma.telkomstorage.R.string.uploads_view_upload_status_service_interrupted
                        );
                        break;
                    case CANCELLED:
                        // should not get here ; cancelled uploads should be wiped out
                        status = mParentActivity.getString(
                                com.telkomsigma.telkomstorage.R.string.uploads_view_upload_status_cancelled
                        );
                        break;
                    case UPLOADED:
                    ...
                    case MAINTENANCE_MODE:
                        status = mParentActivity.getString(com.telkomsigma.telkomstorage.R.string.maintenance_mode);
                        break;
                    case SSL_RECOVERABLE_PEER_UNVERIFIED:
                        status =
                                mParentActivity.getString(
                                        com.telkomsigma.telkomstorage.R.string.uploads_view_upload_status_failed_ssl_certificate_not_trusted
                                );
                        break;
                    case UNKNOWN:
                        status = mParentActivity.getString(com.telkomsigma.telkomstorage.R.string.uploads_view_upload_status_unknown_fail);
                        break;
                    case DELAYED_IN_POWER_SAVE_MODE:
                        status = mParentActivity.getString(
                                com.telkomsigma.telkomstorage.R.string.uploads_view_upload_status_waiting_exit_power_save_mode);
                        break;
                    default:
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflaInflater.inflate(com.telkomsigma.telkomstorage.R.layout.upload_list_group, null);
        }
        TextView tv = convertView.findViewById(com.telkomsigma.telkomstorage.R.id.uploadListGroupName);
        tv.setText(String.format(mParentActivity.getString(com.telkomsigma.telkomstorage.R.string.uploads_view_group_header),
