    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (file != null) {
            ...
            if (!ViewType.GRID_IMAGE.equals(viewType)) {
                TextView fileName = view.findViewById(com.telkomsigma.telkomstorage.R.id.Filename);
            ...
            if (!isGridView) {
                ...
                view.findViewById(com.telkomsigma.telkomstorage.R.id.overflow_menu).setVisibility(View.GONE);
            }
            ...
            if (!file.isDirectory()) {
                ...
                if (parentList.getChoiceMode() == ListView.CHOICE_MODE_NONE) {
                    ...
                    if (parentList.isItemChecked(position)) {
                        checkBoxV.setImageResource(com.telkomsigma.telkomstorage.R.drawable.ic_checkbox_marked);
                    } else {
            ...
            view.findViewById(com.telkomsigma.telkomstorage.R.id.localFileIndicator).setVisibility(View.INVISIBLE);
