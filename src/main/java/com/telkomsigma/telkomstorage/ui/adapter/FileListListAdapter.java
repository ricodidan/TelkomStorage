...
import com.telkomsigma.telkomstorage.files.services.FileDownloader.FileDownloaderBinder;
import com.telkomsigma.telkomstorage.files.services.FileUploader.FileUploaderBinder;
...
import com.telkomsigma.telkomstorage.ui.interfaces.OCFileListFragmentInterface;
...
public class FileListListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null || convertView.getTag() != viewType) {
            switch (viewType) {
                case GRID_IMAGE:
                    view = inflater.inflate(com.telkomsigma.telkomstorage.R.layout.grid_image, parent, false);
                    view.setTag(ViewType.GRID_IMAGE);
                    break;
                case GRID_ITEM:
                    view = inflater.inflate(com.telkomsigma.telkomstorage.R.layout.grid_item, parent, false);
                    view.setTag(ViewType.GRID_ITEM);
                    break;
                case LIST_ITEM:
                    view = inflater.inflate(com.telkomsigma.telkomstorage.R.layout.list_item, parent, false);
        ...
        if (file != null) {
            ...
            switch (viewType) {
                case LIST_ITEM:
                    TextView fileSizeV = view.findViewById(com.telkomsigma.telkomstorage.R.id.file_size);
                    TextView fileSizeSeparatorV = view.findViewById(com.telkomsigma.telkomstorage.R.id.file_separator);
                    TextView lastModV = view.findViewById(com.telkomsigma.telkomstorage.R.id.last_mod);
                ...
                case GRID_ITEM:
                    // filename
                    fileName = view.findViewById(com.telkomsigma.telkomstorage.R.id.Filename);
                ...
                case GRID_IMAGE:
                    ...
                    // local state
                    ImageView localStateView = view.findViewById(com.telkomsigma.telkomstorage.R.id.localFileIndicator);
                    ...
                    if (opsBinder != null && opsBinder.isSynchronizing(mAccount, file)) {
                        //synchronizing
                        localStateView.setImageResource(com.telkomsigma.telkomstorage.R.drawable.ic_synchronizing);
                        ...
                        // conflict
                        localStateView.setImageResource(com.telkomsigma.telkomstorage.R.drawable.ic_synchronizing_error);
                        localStateView.setVisibility(View.VISIBLE);

                    } else if (file.isDown()) {
                        localStateView.setImageResource(com.telkomsigma.telkomstorage.R.drawable.ic_synced);
                        localStateView.setVisibility(View.VISIBLE);
                    }
            ...
            if (file.getIsFavorite()) {
                view.findViewById(com.telkomsigma.telkomstorage.R.id.favorite_action).setVisibility(View.VISIBLE);
            } else {
                view.findViewById(com.telkomsigma.telkomstorage.R.id.favorite_action).setVisibility(View.GONE);
            }

            ImageView checkBoxV = view.findViewById(com.telkomsigma.telkomstorage.R.id.custom_checkbox);
            ...
            if (parentList.getChoiceMode() != AbsListView.CHOICE_MODE_NONE && parentList.getCheckedItemCount() > 0) {
                if (parentList.isItemChecked(position)) {
                    view.setBackgroundColor(mContext.getResources().getColor(com.telkomsigma.telkomstorage.R.color.selected_item_background));
                    checkBoxV.setImageDrawable(ThemeUtils.tintDrawable(com.telkomsigma.telkomstorage.R.drawable.ic_checkbox_marked,
                            ThemeUtils.primaryColor()));
                } else {
                    view.setBackgroundColor(Color.WHITE);
                    checkBoxV.setImageResource(com.telkomsigma.telkomstorage.R.drawable.ic_checkbox_blank_outline);
                }
                ...
                if (mHideItemOptions) {
                    ImageView sharedIconView = view.findViewById(com.telkomsigma.telkomstorage.R.id.sharedIcon);
                    sharedIconView.setVisibility(View.GONE);

                    ImageView overflowIndicatorView = view.findViewById(com.telkomsigma.telkomstorage.R.id.overflow_menu);
            ...
            if (!file.isAvailableOffline()) {
                view.findViewById(com.telkomsigma.telkomstorage.R.id.keptOfflineIcon).setVisibility(View.GONE);
            } else {
                view.findViewById(com.telkomsigma.telkomstorage.R.id.keptOfflineIcon).setVisibility(View.VISIBLE);
            }
            ...
            if (!file.isFolder()) {
                if ((MimeTypeUtil.isImage(file) || MimeTypeUtil.isVideo(file)) && file.getRemoteId() != null) {
                    ...
                    if (file.getMimetype().equalsIgnoreCase("image/png")) {
                        fileIcon.setBackgroundColor(mContext.getResources().getColor(com.telkomsigma.telkomstorage.R.color.background_color));
                    }
    ...
    private void showShareIcon(View view, OCFile file) {
        ImageView sharedIconV = view.findViewById(com.telkomsigma.telkomstorage.R.id.sharedIcon);
        sharedIconV.setVisibility(View.VISIBLE);
        if (file.isSharedWithSharee() || file.isSharedWithMe()) {
            sharedIconV.setImageResource(com.telkomsigma.telkomstorage.R.drawable.shared_via_users);
        } else if (file.isSharedViaLink()) {
            sharedIconV.setImageResource(com.telkomsigma.telkomstorage.R.drawable.shared_via_link);
        } else {
            sharedIconV.setImageResource(com.telkomsigma.telkomstorage.R.drawable.ic_unshared);
        }
    ...
    private void hideShareIcon(View view) {
        view.findViewById(com.telkomsigma.telkomstorage.R.id.sharedIcon).setVisibility(View.GONE);
    }

    private void showOverflowMenuIcon(View view, OCFile file, ViewType viewType) {
        if (ViewType.LIST_ITEM.equals(viewType)) {
            ImageView overflowIndicatorV = view.findViewById(com.telkomsigma.telkomstorage.R.id.overflow_menu);
