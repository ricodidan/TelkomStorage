...
public class PreviewTextFragment extends FileFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View ret = inflater.inflate(com.telkomsigma.telkomstorage.R.layout.text_file_preview, container, false);

        mTextPreview = ret.findViewById(com.telkomsigma.telkomstorage.R.id.text_preview);

        mMultiView = ret.findViewById(com.telkomsigma.telkomstorage.R.id.multi_view);
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        item = menu.findItem(com.telkomsigma.telkomstorage.R.id.action_download_file);
        if (item != null) {
            item.setVisible(false);
            item.setEnabled(false);
        }
        ...
        item = menu.findItem(com.telkomsigma.telkomstorage.R.id.action_sync_account);
        if (item != null) {
            item.setVisible(false);
            item.setEnabled(false);
        }

        Boolean dualPane = getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.large_land_layout);

        item = menu.findItem(com.telkomsigma.telkomstorage.R.id.action_switch_view);
        if (item != null && !dualPane) {
            item.setVisible(false);
            item.setEnabled(false);
        }

        item = menu.findItem(com.telkomsigma.telkomstorage.R.id.action_sort);
        if (item != null && !dualPane) {
            item.setVisible(false);
            item.setEnabled(false);
        }
