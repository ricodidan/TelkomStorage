...
public class FileDownloadFragment extends FileFragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(com.telkomsigma.telkomstorage.R.layout.file_download_fragment, container, false);

        ProgressBar progressBar = mView.findViewById(com.telkomsigma.telkomstorage.R.id.progressBar);
        ThemeUtils.colorHorizontalProgressBar(progressBar, ThemeUtils.primaryAccentColor());
        mProgressListener = new ProgressListener(progressBar);

        (mView.findViewById(com.telkomsigma.telkomstorage.R.id.cancelBtn)).setOnClickListener(this);

        (mView.findViewById(com.telkomsigma.telkomstorage.R.id.fileDownloadLL)).setOnClickListener(new OnClickListener() {
            @Override
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.telkomsigma.telkomstorage.R.id.cancelBtn: {
    ...
    private void setButtonsForTransferring() {
        getView().findViewById(com.telkomsigma.telkomstorage.R.id.cancelBtn).setVisibility(View.VISIBLE);

        // show the progress bar for the transfer
        getView().findViewById(com.telkomsigma.telkomstorage.R.id.progressBar).setVisibility(View.VISIBLE);
        TextView progressText = getView().findViewById(com.telkomsigma.telkomstorage.R.id.progressText);
        progressText.setText(com.telkomsigma.telkomstorage.R.string.downloader_download_in_progress_ticker);
        progressText.setVisibility(View.VISIBLE);

        // hides the error icon
        getView().findViewById(com.telkomsigma.telkomstorage.R.id.errorText).setVisibility(View.GONE);
        getView().findViewById(com.telkomsigma.telkomstorage.R.id.error_image).setVisibility(View.GONE);
    }
    ...
    private void setButtonsForRemote() {
        getView().findViewById(com.telkomsigma.telkomstorage.R.id.cancelBtn).setVisibility(View.GONE);

        // hides the progress bar and message
        getView().findViewById(com.telkomsigma.telkomstorage.R.id.progressBar).setVisibility(View.GONE);
        getView().findViewById(com.telkomsigma.telkomstorage.R.id.progressText).setVisibility(View.GONE);

        // shows the error icon and message
        getView().findViewById(com.telkomsigma.telkomstorage.R.id.errorText).setVisibility(View.VISIBLE);
        getView().findViewById(com.telkomsigma.telkomstorage.R.id.error_image).setVisibility(View.VISIBLE);
    }
