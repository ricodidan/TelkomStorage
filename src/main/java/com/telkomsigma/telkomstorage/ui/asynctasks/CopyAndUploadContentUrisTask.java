 ...
 */
package com.telkomsigma.telkomstorage.ui.asynctasks;
            ...
            if (result != ResultCode.OK) {
                ...
                switch (result) {
                    case LOCAL_FILE_NOT_FOUND:
                        messageId = com.telkomsigma.telkomstorage.R.string.uploader_error_message_source_file_not_found;
                        break;
                    case LOCAL_STORAGE_NOT_COPIED:
                        messageId = com.telkomsigma.telkomstorage.R.string.uploader_error_message_source_file_not_copied;
                        break;
                    case FORBIDDEN:
                        messageId = com.telkomsigma.telkomstorage.R.string.uploader_error_message_read_permission_not_granted;
                        break;
                    default:
                        messageId = com.telkomsigma.telkomstorage.R.string.common_error_unknown;
                        break;
                }
                String message = String.format(
                        mAppContext.getString(messageId),
                        mAppContext.getString(com.telkomsigma.telkomstorage.R.string.app_name)
                );
