...
import com.telkomsigma.telkomstorage.ui.adapter.ShareUserListAdapter;
import com.telkomsigma.telkomstorage.ui.dialog.ExpirationDatePickerDialogFragment;
import com.telkomsigma.telkomstorage.ui.dialog.SharePasswordDialogFragment;
...
//    private static final String FTAG_CHOOSER_DIALOG = "CHOOSER_DIALOG";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (ThemeUtils.themingEnabled()) {
            getContext().getTheme().applyStyle(com.telkomsigma.telkomstorage.R.style.FallbackThemingTheme, true);
        }

        int accentColor = ThemeUtils.primaryAccentColor();

        // Inflate the layout for this fragment
        View view = inflater.inflate(com.telkomsigma.telkomstorage.R.layout.share_file_layout, container, false);

        // Setup layout
        // Image
        ImageView icon = view.findViewById(com.telkomsigma.telkomstorage.R.id.shareFileIcon);
        ...
        // Title
        TextView title = view.findViewById(com.telkomsigma.telkomstorage.R.id.shareWithUsersSectionTitle);
        title.setTextColor(accentColor);

        // Name
        TextView fileNameHeader = view.findViewById(com.telkomsigma.telkomstorage.R.id.shareFileName);
        fileNameHeader.setText(getResources().getString(com.telkomsigma.telkomstorage.R.string.share_file, mFile.getFileName()));

        View headerDivider = view.findViewById(com.telkomsigma.telkomstorage.R.id.share_header_divider);
        headerDivider.getBackground().setColorFilter(ThemeUtils.primaryAccentColor(), PorterDuff.Mode.SRC_ATOP);

        // Size
        TextView size = view.findViewById(com.telkomsigma.telkomstorage.R.id.shareFileSize);
        if (mFile.isFolder()) {
        ...
        //  Add User Button
        Button addUserGroupButton = view.findViewById(com.telkomsigma.telkomstorage.R.id.addUserButton);
            ...
            public void onClick(View view) {
                ...
                if (shareWithUsersEnable) {
                    ...
                    Snackbar.make(
                            ...
                            getString(com.telkomsigma.telkomstorage.R.string.share_sharee_unavailable),
    ...
    private void initShareViaLinkListener(View shareView) {
        ...
        SwitchCompat shareViaLinkSwitch = shareView.findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkSectionSwitch);
    ...
    private void initExpirationListener(View shareView) {
        ...
        SwitchCompat expirationSwitch = shareView.findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkExpirationSwitch);
        ...
        shareView.findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkExpirationLabel).
                setOnClickListener(mOnExpirationDateInteractionListener);

        shareView.findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkExpirationValue).
                setOnClickListener(mOnExpirationDateInteractionListener);
    }
    ...
    private void initPasswordListener(View shareView) {
        ...
        SwitchCompat passwordSwitch = shareView.findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkPasswordSwitch);
        ...
        shareView.findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkPasswordLabel).setOnClickListener(mOnPasswordInteractionListener);

        shareView.findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkPasswordValue).setOnClickListener(mOnPasswordInteractionListener);
    }
    ...
    private void initEditPermissionListener(View shareView) {
        ...
        SwitchCompat permissionSwitch = shareView.findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkEditPermissionSwitch);
    ...
    private void initHideFileListingListener(View shareView) {
        ...
        SwitchCompat permissionSwitch = shareView.findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkFileListingPermissionSwitch);
    ...
    private void updateListOfUserGroups() {
        ...
        ShareUserListAdapter mUserGroupsAdapter = new ShareUserListAdapter(
                getActivity(),
                com.telkomsigma.telkomstorage.R.layout.share_user_item,
                mPrivateShares,
                this
        );

        // Show data
        TextView noShares = getView().findViewById(com.telkomsigma.telkomstorage.R.id.shareNoUsers);
        ListView usersList = getView().findViewById(com.telkomsigma.telkomstorage.R.id.shareUsersList);
        ...
        ScrollView scrollView = getView().findViewById(com.telkomsigma.telkomstorage.R.id.shareScroll);
    ...
    private void updatePublicShareSection() {
        if (mPublicShare != null && ShareType.PUBLIC_LINK.equals(mPublicShare.getShareType())) {
            ...
            if (expirationDate > 0) {
                ...
                getExpirationDateValue().setText(com.telkomsigma.telkomstorage.R.string.empty);
            }
    ...
    private SwitchCompat getShareViaLinkSwitch() {
        return (SwitchCompat) getView().findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkSectionSwitch);
    }

    private View getExpirationDateSection() {
        return getView().findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkExpirationSection);
    }

    private SwitchCompat getExpirationDateSwitch() {
        return (SwitchCompat) getView().findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkExpirationSwitch);
    }

    private TextView getExpirationDateValue() {
        return (TextView) getView().findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkExpirationValue);
    }
    ...
    private View getPasswordSection() {
        return getView().findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkPasswordSection);
    }

    private SwitchCompat getPasswordSwitch() {
        return (SwitchCompat) getView().findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkPasswordSwitch);
    }

    private TextView getPasswordValue() {
        return (TextView) getView().findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkPasswordValue);
    }

    private View getEditPermissionSection() {
        return getView().findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkEditPermissionSection);
    }

    private SwitchCompat getEditPermissionSwitch() {
        return (SwitchCompat) getView().findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkEditPermissionSwitch);
    }

    private SwitchCompat getHideFileListingPermissionSwitch() {
        return (SwitchCompat) getView().findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkFileListingPermissionSwitch);
    }

    private View getHideFileListingPermissionSection() {
        return getView().findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkHideFileListingPermissionSection);
    }

    private AppCompatButton getGetLinkButton() {
        return (AppCompatButton) getView().findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkGetLinkButton);
    }
    ...
    private void hideNotEnabledShareSections(View view) {
        LinearLayout shareWithUsersSection = view.findViewById(com.telkomsigma.telkomstorage.R.id.shareWithUsersSection);
        LinearLayout shareViaLinkSection = view.findViewById(com.telkomsigma.telkomstorage.R.id.shareViaLinkSection);

        boolean shareViaLinkAllowed = getActivity().getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.share_via_link_feature);
        boolean shareWithUsersAllowed = getActivity().getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.share_with_users_feature);
    ...
    private class OnHideFileListingPermissionInteractionListener implements CompoundButton.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(CompoundButton switchView, boolean isChecked) {
            ...
            if (mCapabilities.getFilesFileDrop().isTrue()) {
                ...
                Snackbar.make(getView(), com.telkomsigma.telkomstorage.R.string.files_drop_not_supported, Snackbar.LENGTH_LONG)
                        .setAction(com.telkomsigma.telkomstorage.R.string.learn_more, new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent i = new Intent(Intent.ACTION_VIEW);
                                i.setData(Uri.parse(getString(com.telkomsigma.telkomstorage.R.string.url_server_install)));
                                startActivity(i);
                            }
                        })
                        .show();
