...
public class EditShareFragment extends Fragment {
    ...
    private static final int sSubordinateCheckBoxIds[] = {
            com.telkomsigma.telkomstorage.R.id.canEditCreateCheckBox,
            com.telkomsigma.telkomstorage.R.id.canEditChangeCheckBox,
            com.telkomsigma.telkomstorage.R.id.canEditDeleteCheckBox
    };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.telkomsigma.telkomstorage.R.layout.edit_share_layout, container, false);

        ((TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.editShareTitle)).setText(
                getResources().getString(com.telkomsigma.telkomstorage.R.string.share_with_edit_title, mShare.getSharedWithDisplayName()));
    ...
    private void refreshUiFromState(View editShareView) {
        if (editShareView != null) {
            ...
            SwitchCompat shareSwitch = editShareView.findViewById(com.telkomsigma.telkomstorage.R.id.canShareSwitch);
            ...
            SwitchCompat switchCompat = editShareView.findViewById(com.telkomsigma.telkomstorage.R.id.canEditSwitch);
            ...
            if (mFile.isFolder() && areEditOptionsAvailable) {
                ...
                AppCompatCheckBox checkBox = editShareView.findViewById(com.telkomsigma.telkomstorage.R.id.canEditCreateCheckBox);
                ...
                checkBox = editShareView.findViewById(com.telkomsigma.telkomstorage.R.id.canEditChangeCheckBox);
                checkBox.setChecked((sharePermissions & OCShare.UPDATE_PERMISSION_FLAG) > 0);
                checkBox.setVisibility((canEdit) ? View.VISIBLE : View.GONE);
                ThemeUtils.tintCheckbox(checkBox, accentColor);

                checkBox = editShareView.findViewById(com.telkomsigma.telkomstorage.R.id.canEditDeleteCheckBox);
    ...
    private void setPermissionsListening(View editShareView, boolean enable) {
        ...
        compound = editShareView.findViewById(com.telkomsigma.telkomstorage.R.id.canShareSwitch);
        compound.setOnCheckedChangeListener(changeListener);

        compound = editShareView.findViewById(com.telkomsigma.telkomstorage.R.id.canEditSwitch);
        compound.setOnCheckedChangeListener(changeListener);

        if (mFile.isFolder()) {
            compound = editShareView.findViewById(com.telkomsigma.telkomstorage.R.id.canEditCreateCheckBox);
            compound.setOnCheckedChangeListener(changeListener);

            compound = editShareView.findViewById(com.telkomsigma.telkomstorage.R.id.canEditChangeCheckBox);
            compound.setOnCheckedChangeListener(changeListener);

            compound = editShareView.findViewById(com.telkomsigma.telkomstorage.R.id.canEditDeleteCheckBox);
            compound.setOnCheckedChangeListener(changeListener);
        }
    ...
    private SwitchCompat getCanShareSwitch() {
        return (SwitchCompat) getView().findViewById(com.telkomsigma.telkomstorage.R.id.canShareSwitch);
    }
    ...
    private SwitchCompat getCanEditSwitch() {
        return (SwitchCompat) getView().findViewById(com.telkomsigma.telkomstorage.R.id.canEditSwitch);
    }
    ...
    private CheckBox getCanEditCreateCheckBox() {
        return (CheckBox) getView().findViewById(com.telkomsigma.telkomstorage.R.id.canEditCreateCheckBox);
    }
    ...
    private CheckBox getCanEditChangeCheckBox() {
        return (CheckBox) getView().findViewById(com.telkomsigma.telkomstorage.R.id.canEditChangeCheckBox);
    }
    ...
    private CheckBox getCanEditDeleteCheckBox() {
        return (CheckBox) getView().findViewById(com.telkomsigma.telkomstorage.R.id.canEditDeleteCheckBox);
    }
    ...
    private class OnPrivilegeChangeListener
        ...
        public void onCheckedChanged(CompoundButton compound, boolean isChecked) {
            ...
            switch (compound.getId()) {
                case com.telkomsigma.telkomstorage.R.id.canShareSwitch:
                    Log_OC.v(TAG, "canShareCheckBox toggled to " + isChecked);
                    updatePermissionsToShare();
                    break;

                case com.telkomsigma.telkomstorage.R.id.canEditSwitch:
                    ...
                    if (mFile.isFolder()) {
                        if (isChecked) {
                            if (!isFederated) {
                                ...
                                //noinspection ConstantConditions, prevented in the method beginning
                                subordinate = getView().findViewById(com.telkomsigma.telkomstorage.R.id.canEditDeleteCheckBox);
                                if (!subordinate.isChecked()) {
                                    toggleDisablingListener(subordinate);
                                }
                ...
                case com.telkomsigma.telkomstorage.R.id.canEditCreateCheckBox:
                    Log_OC.v(TAG, "canEditCreateCheckBox toggled to " + isChecked);
                    syncCanEditSwitch(compound, isChecked);
                    updatePermissionsToShare();
                    break;

                case com.telkomsigma.telkomstorage.R.id.canEditChangeCheckBox:
                    Log_OC.v(TAG, "canEditChangeCheckBox toggled to " + isChecked);
                    syncCanEditSwitch(compound, isChecked);
                    updatePermissionsToShare();
                    break;

                case com.telkomsigma.telkomstorage.R.id.canEditDeleteCheckBox:
        ...
        private void syncCanEditSwitch(View subordinateCheckBoxView, boolean isChecked) {
            CompoundButton canEditCompound = getView().findViewById(com.telkomsigma.telkomstorage.R.id.canEditSwitch);
            if (isChecked) {
