 ...
 */
package com.telkomsigma.telkomstorage.ui.fragment.contactsbackup;
...
import com.telkomsigma.telkomstorage.jobs.ContactsBackupJob;
import com.telkomsigma.telkomstorage.operations.RefreshFolderOperation;
import com.telkomsigma.telkomstorage.ui.activity.ContactsPreferenceActivity;
import com.telkomsigma.telkomstorage.ui.activity.Preferences;
...
public class ContactsBackupFragment extends FileFragment implements DatePickerDialog.OnDateSetListener {
    ...
    @BindView(com.telkomsigma.telkomstorage.R.id.contacts_automatic_backup)
    public SwitchCompat backupSwitch;
    @BindView(com.telkomsigma.telkomstorage.R.id.contacts_datepicker)
    public AppCompatButton contactsDatePickerBtn;
    @BindView(com.telkomsigma.telkomstorage.R.id.contacts_last_backup_timestamp)
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(com.telkomsigma.telkomstorage.R.layout.contacts_backup_fragment, null);
        ...
        contactsPreferenceActivity.getSupportActionBar().setTitle(com.telkomsigma.telkomstorage.R.string.actionbar_contacts);
        ...
        if (lastBackupTimestamp == -1) {
            lastBackup.setText(com.telkomsigma.telkomstorage.R.string.contacts_preference_backup_never);
        } else {
        ...
        view.findViewById(com.telkomsigma.telkomstorage.R.id.contacts_backup_now).getBackground()
                .setColorFilter(accentColor, PorterDuff.Mode.SRC_ATOP);

        AppCompatButton chooseDate = view.findViewById(com.telkomsigma.telkomstorage.R.id.contacts_datepicker);
    ...
    public void onResume() {
        ...
        String backupFolderPath = getResources().getString(com.telkomsigma.telkomstorage.R.string.contacts_backup_folder) + OCFile.PATH_SEPARATOR;
    ...
    @OnClick(com.telkomsigma.telkomstorage.R.id.contacts_backup_now)
    ...
    private void startContactsBackupJob() {
        ...
        Snackbar.make(getView().findViewById(com.telkomsigma.telkomstorage.R.id.contacts_linear_layout),
                com.telkomsigma.telkomstorage.R.string.contacts_preferences_backup_scheduled,
    ...
    private void setAutomaticBackup(final boolean bool) {
        ...
        arbitraryDataProvider.storeOrUpdateKeyValue(account.name, ContactsPreferenceActivity.PREFERENCE_CONTACTS_AUTOMATIC_BACKUP,
                String.valueOf(bool));
    }
    ...
    private boolean checkAndAskForContactsReadPermission() {
        ...
        if ((PermissionUtil.checkSelfPermission(contactsPreferenceActivity, Manifest.permission.READ_CONTACTS))) {
            ...
            if (PermissionUtil.shouldShowRequestPermissionRationale(contactsPreferenceActivity,
                ...
                Snackbar snackbar = Snackbar.make(getView().findViewById(com.telkomsigma.telkomstorage.R.id.contacts_linear_layout),
                        com.telkomsigma.telkomstorage.R.string.contacts_read_permission,
    ...
    @OnClick(com.telkomsigma.telkomstorage.R.id.contacts_datepicker)
    ...
    public void openDate(@Nullable Date savedDate) {
        ...
        String backupFolderString = getResources().getString(com.telkomsigma.telkomstorage.R.string.contacts_backup_folder) + OCFile.PATH_SEPARATOR;
        ...
        if (backupFiles.size() > 0 && backupFiles.lastElement() != null) {
            ...
            Toast.makeText(contactsPreferenceActivity, com.telkomsigma.telkomstorage.R.string.contacts_preferences_something_strange_happened,
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        ...
        if (backupToRestore != null) {
            ...
            contactsPreferenceActivity.getSupportFragmentManager().
                    beginTransaction()
                    .replace(com.telkomsigma.telkomstorage.R.id.frame_container, contactListFragment, ContactListFragment.TAG)
                    .addToBackStack(ContactsPreferenceActivity.BACKUP_TO_LIST)
                    .commit();
        } else {
            Toast.makeText(contactsPreferenceActivity, com.telkomsigma.telkomstorage.R.string.contacts_preferences_no_file_found,
                    Toast.LENGTH_SHORT).show();
        }
    }
}
