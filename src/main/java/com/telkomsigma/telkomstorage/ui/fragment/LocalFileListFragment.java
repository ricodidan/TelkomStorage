...
public class LocalFileListFragment extends ExtendedListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (!mContainerActivity.isFolderPickerMode()) {
            ...
            setMessageForEmptyList(com.telkomsigma.telkomstorage.R.string.file_list_empty_headline, com.telkomsigma.telkomstorage.R.string.local_file_list_empty,
                    com.telkomsigma.telkomstorage.R.drawable.ic_list_empty_folder, true);
        } else {
            setMessageForEmptyList(com.telkomsigma.telkomstorage.R.string.folder_list_empty_headline, com.telkomsigma.telkomstorage.R.string.local_folder_list_empty,
                    com.telkomsigma.telkomstorage.R.drawable.ic_list_empty_folder, true);
        }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        if (mContainerActivity.isFolderPickerMode()) {
            menu.removeItem(com.telkomsigma.telkomstorage.R.id.action_select_all_action_menu);
            menu.removeItem(com.telkomsigma.telkomstorage.R.id.action_search);
        } else {
    ...
    public void onItemClick(AdapterView<?> l, View v, int position, long id) {
        ...
        if (file != null) {
            ...
            if (file.isDirectory()) {
                ...
                ImageView checkBoxV = v.findViewById(com.telkomsigma.telkomstorage.R.id.custom_checkbox);
                if (checkBoxV != null) {
                    if (getListView().isItemChecked(position)) {
                        v.setBackgroundColor(getContext().getResources().getColor(com.telkomsigma.telkomstorage.R.color.selected_item_background));
