...
import com.telkomsigma.telkomstorage.jobs.ContactsImportJob;
...
import com.telkomsigma.telkomstorage.ui.events.VCardToggleEvent;
...
import static com.telkomsigma.telkomstorage.ui.fragment.contactsbackup.ContactListFragment.getDisplayName;
...
public class ContactListFragment extends FileFragment {
    ...
    @BindView(com.telkomsigma.telkomstorage.R.id.contactlist_recyclerview)
    public RecyclerView recyclerView;

    @BindView(com.telkomsigma.telkomstorage.R.id.contactlist_restore_selected_container)
    public LinearLayout restoreContactsContainer;

    @BindView(com.telkomsigma.telkomstorage.R.id.contactlist_restore_selected)
    ...
    @BindView(com.telkomsigma.telkomstorage.R.id.empty_list_container)
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(com.telkomsigma.telkomstorage.R.menu.contactlist_menu, menu);
    }

    @Override
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        View view = inflater.inflate(com.telkomsigma.telkomstorage.R.layout.contactlist_fragment, container, false);
        ...
        if (actionBar != null) {
            actionBar.setTitle(com.telkomsigma.telkomstorage.R.string.actionbar_contacts_restore);
            actionBar.setDisplayHomeAsUpEnabled(true);
        }
        contactsPreferenceActivity.setDrawerIndicatorEnabled(false);

        recyclerView = view.findViewById(com.telkomsigma.telkomstorage.R.id.contactlist_recyclerview);
    ...
    private void setSelectAllMenuItem(MenuItem selectAll, boolean checked) {
        ...
        if (checked) {
            selectAll.setIcon(com.telkomsigma.telkomstorage.R.drawable.ic_select_none);
        } else {
            selectAll.setIcon(com.telkomsigma.telkomstorage.R.drawable.ic_select_all);
        }
    }
    ...
    private void importContacts(ContactAccount account) {
        ...
        Snackbar.make(recyclerView, com.telkomsigma.telkomstorage.R.string.contacts_preferences_import_scheduled, Snackbar.LENGTH_LONG).show();
    ...
    private void getAccountForImport() {
        ...
        if (accounts.size() == 1) {
            ...
            builder.setTitle(com.telkomsigma.telkomstorage.R.string.contactlist_account_chooser_title)
            ...
            for (int index = 0; index < permissions.length; index++) {
                if (Manifest.permission.WRITE_CONTACTS.equalsIgnoreCase(permissions[index])) {
                    if (grantResults[index] >= 0) {
                        ...
                        if (getView() != null) {
                            Snackbar.make(getView(), com.telkomsigma.telkomstorage.R.string.contactlist_no_permission, Snackbar.LENGTH_LONG)
                                    .show();
                        } else {
                            Toast.makeText(getContext(), com.telkomsigma.telkomstorage.R.string.contactlist_no_permission, Toast.LENGTH_LONG).show();
                        }
                    }
                    break;
                }
    ...
    static class ContactItemViewHolder extends RecyclerView.ViewHolder {
        ...
        ContactItemViewHolder(View itemView) {
            ...
            badge = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.contactlist_item_icon);
            name = itemView.findViewById(com.telkomsigma.telkomstorage.R.id.contactlist_item_name);
...
class ContactListAdapter extends RecyclerView.Adapter<ContactListFragment.ContactItemViewHolder> {
    ...
    public ContactListFragment.ContactItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(com.telkomsigma.telkomstorage.R.layout.contactlist_list_item, parent, false);
        ...
        if (vcard != null) {
            ...
            if (vcard.getPhotos().size() > 0) {
                ...
                if (data != null && data.length > 0) {
                    ...
                    DisplayUtils.downloadIcon(context, url, target, com.telkomsigma.telkomstorage.R.drawable.ic_user,
                ...
                try {
                    holder.getBadge().setImageDrawable(
                            TextDrawable.createNamedAvatar(
                                    ...
                                    context.getResources().getDimension(com.telkomsigma.telkomstorage.R.dimen.list_item_avatar_icon_radius)
                            )
                    );
                } catch (Exception e) {
                    holder.getBadge().setImageResource(com.telkomsigma.telkomstorage.R.drawable.ic_user);
                }
            }
