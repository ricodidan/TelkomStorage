...
import com.telkomsigma.telkomstorage.ui.ExtendedListView;
import com.telkomsigma.telkomstorage.ui.activity.FileDisplayActivity;
import com.telkomsigma.telkomstorage.ui.activity.FolderPickerActivity;
import com.telkomsigma.telkomstorage.ui.activity.OnEnforceableRefreshListener;
import com.telkomsigma.telkomstorage.ui.activity.UploadFilesActivity;
import com.telkomsigma.telkomstorage.ui.adapter.FileListListAdapter;
import com.telkomsigma.telkomstorage.ui.adapter.LocalFileListAdapter;
...
public class ExtendedListFragment extends Fragment
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        final MenuItem item = menu.findItem(com.telkomsigma.telkomstorage.R.id.action_search);
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (getActivity() != null && !(getActivity() instanceof FolderPickerActivity)) {
                            ...
                            if (getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.bottom_toolbar_enabled) && searchSupported) {
                                BottomNavigationView bottomNavigationView = getActivity().
                                        findViewById(com.telkomsigma.telkomstorage.R.id.bottom_navigation_view);
                                if (hasFocus) {
        ...
        LinearLayout searchBar = searchView.findViewById(com.telkomsigma.telkomstorage.R.id.search_bar);
        TextView searchBadge = searchView.findViewById(com.telkomsigma.telkomstorage.R.id.search_badge);

        searchBadge.setTextColor(fontColor);
        searchBadge.setHintTextColor(fontColor);

        ImageView searchButton = searchView.findViewById(com.telkomsigma.telkomstorage.R.id.search_button);
        searchButton.setImageDrawable(ThemeUtils.tintDrawable(com.telkomsigma.telkomstorage.R.drawable.ic_search, fontColor));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.telkomsigma.telkomstorage.R.layout.list_fragment, null);
        setupEmptyList(v);

        mListView = v.findViewById(com.telkomsigma.telkomstorage.R.id.list_root);
        mListView.setOnItemClickListener(this);
        mListFooterView = inflater.inflate(com.telkomsigma.telkomstorage.R.layout.list_footer, null, false);

        mGridView = v.findViewById(com.telkomsigma.telkomstorage.R.id.grid_root);
        ...
        mGridFooterView = inflater.inflate(com.telkomsigma.telkomstorage.R.layout.list_footer, null, false);
        ...
        mRefreshListLayout = v.findViewById(com.telkomsigma.telkomstorage.R.id.swipe_containing_list);
        mRefreshGridLayout = v.findViewById(com.telkomsigma.telkomstorage.R.id.swipe_containing_grid);
        mRefreshEmptyLayout = v.findViewById(com.telkomsigma.telkomstorage.R.id.swipe_containing_empty);
        ...
        mFabMain = v.findViewById(com.telkomsigma.telkomstorage.R.id.fab_main);
        ...
        mFabUpload = v.findViewById(com.telkomsigma.telkomstorage.R.id.fab_upload);
        mFabUpload.setColorNormal(primaryColor);
        mFabUpload.setColorPressed(primaryColorDark);
        mFabUpload.setIconDrawable(ThemeUtils.tintDrawable(com.telkomsigma.telkomstorage.R.drawable.ic_action_upload, fontColor));

        mFabMkdir = v.findViewById(com.telkomsigma.telkomstorage.R.id.fab_mkdir);
        mFabMkdir.setColorNormal(primaryColor);
        mFabMkdir.setColorPressed(primaryColorDark);
        mFabMkdir.setIconDrawable(ThemeUtils.tintDrawable(com.telkomsigma.telkomstorage.R.drawable.ic_action_create_dir, fontColor));

        mFabUploadFromApp = v.findViewById(com.telkomsigma.telkomstorage.R.id.fab_upload_from_app);
        mFabUploadFromApp.setColorNormal(primaryColor);
        mFabUploadFromApp.setColorPressed(primaryColorDark);
        mFabUploadFromApp.setIconDrawable(ThemeUtils.tintDrawable(com.telkomsigma.telkomstorage.R.drawable.ic_import, fontColor));
        ...
        if (getResources().getBoolean(com.telkomsigma.telkomstorage.R.bool.bottom_toolbar_enabled) && searchSupported) {
            ...
            BottomNavigationView bottomNavigationView = v.findViewById(com.telkomsigma.telkomstorage.R.id.bottom_navigation_view);
    ...
    protected void setupEmptyList(View view) {
        mEmptyListContainer = view.findViewById(com.telkomsigma.telkomstorage.R.id.empty_list_view);
        mEmptyListMessage = view.findViewById(com.telkomsigma.telkomstorage.R.id.empty_list_view_text);
        mEmptyListHeadline = view.findViewById(com.telkomsigma.telkomstorage.R.id.empty_list_view_headline);
        mEmptyListIcon = view.findViewById(com.telkomsigma.telkomstorage.R.id.empty_list_icon);
        mEmptyListProgress = view.findViewById(com.telkomsigma.telkomstorage.R.id.empty_list_progress);
            ...
            public void run() {
                ...
                if (searchType == SearchType.NO_SEARCH) {
                    setMessageForEmptyList(
                            ...
                            com.telkomsigma.telkomstorage.R.string.file_list_empty,
                            com.telkomsigma.telkomstorage.R.drawable.ic_list_empty_folder,
                            true
                    );
                } else if (searchType == SearchType.FILE_SEARCH) {
                    setMessageForEmptyList(com.telkomsigma.telkomstorage.R.string.file_list_empty_headline_server_search,
                            com.telkomsigma.telkomstorage.R.string.file_list_empty, com.telkomsigma.telkomstorage.R.drawable.ic_search_light_grey);
                } else if (searchType == SearchType.FAVORITE_SEARCH) {
                    setMessageForEmptyList(com.telkomsigma.telkomstorage.R.string.file_list_empty_favorite_headline,
                            com.telkomsigma.telkomstorage.R.string.file_list_empty_favorites_filter_list, com.telkomsigma.telkomstorage.R.drawable.ic_star_light_yellow);
                } else if (searchType == SearchType.VIDEO_SEARCH) {
                    setMessageForEmptyList(com.telkomsigma.telkomstorage.R.string.file_list_empty_headline_server_search_videos,
                            com.telkomsigma.telkomstorage.R.string.file_list_empty_text_videos, com.telkomsigma.telkomstorage.R.drawable.ic_list_empty_video);
                } else if (searchType == SearchType.PHOTO_SEARCH) {
                    setMessageForEmptyList(com.telkomsigma.telkomstorage.R.string.file_list_empty_headline_server_search_photos,
                            com.telkomsigma.telkomstorage.R.string.file_list_empty_text_photos, com.telkomsigma.telkomstorage.R.drawable.ic_list_empty_image);
                } else if (searchType == SearchType.RECENTLY_MODIFIED_SEARCH) {
                    setMessageForEmptyList(com.telkomsigma.telkomstorage.R.string.file_list_empty_headline_server_search,
                            com.telkomsigma.telkomstorage.R.string.file_list_empty_recently_modified, com.telkomsigma.telkomstorage.R.drawable.ic_list_empty_recent);
                } else if (searchType == SearchType.RECENTLY_ADDED_SEARCH) {
                    setMessageForEmptyList(com.telkomsigma.telkomstorage.R.string.file_list_empty_headline_server_search,
                            com.telkomsigma.telkomstorage.R.string.file_list_empty_recently_added, com.telkomsigma.telkomstorage.R.drawable.ic_list_empty_recent);
                } else if (searchType == SearchType.REGULAR_FILTER) {
                    setMessageForEmptyList(com.telkomsigma.telkomstorage.R.string.file_list_empty_headline_search,
                            com.telkomsigma.telkomstorage.R.string.file_list_empty_search, com.telkomsigma.telkomstorage.R.drawable.ic_search_light_grey);
                } else if (searchType == SearchType.FAVORITE_SEARCH_FILTER) {
                    setMessageForEmptyList(com.telkomsigma.telkomstorage.R.string.file_list_empty_headline_server_search,
                            com.telkomsigma.telkomstorage.R.string.file_list_empty_favorites_filter, com.telkomsigma.telkomstorage.R.drawable.ic_star_light_yellow);
                } else if (searchType == SearchType.VIDEO_SEARCH_FILTER) {
                    setMessageForEmptyList(com.telkomsigma.telkomstorage.R.string.file_list_empty_headline_server_search_videos,
                            com.telkomsigma.telkomstorage.R.string.file_list_empty_text_videos_filter, com.telkomsigma.telkomstorage.R.drawable.ic_list_empty_video);
                } else if (searchType == SearchType.PHOTOS_SEARCH_FILTER) {
                    setMessageForEmptyList(com.telkomsigma.telkomstorage.R.string.file_list_empty_headline_server_search_photos,
                            com.telkomsigma.telkomstorage.R.string.file_list_empty_text_photos_filter, com.telkomsigma.telkomstorage.R.drawable.ic_list_empty_image);
                } else if (searchType == SearchType.RECENTLY_MODIFIED_SEARCH_FILTER) {
                    setMessageForEmptyList(com.telkomsigma.telkomstorage.R.string.file_list_empty_headline_server_search,
                            com.telkomsigma.telkomstorage.R.string.file_list_empty_recently_modified_filter, com.telkomsigma.telkomstorage.R.drawable.ic_list_empty_recent);
                } else if (searchType == SearchType.RECENTLY_ADDED_SEARCH_FILTER) {
                    setMessageForEmptyList(com.telkomsigma.telkomstorage.R.string.file_list_empty_headline_server_search,
                            com.telkomsigma.telkomstorage.R.string.file_list_empty_recently_added_filter, com.telkomsigma.telkomstorage.R.drawable.ic_list_empty_recent);
                } else if (searchType == SearchType.SHARED_FILTER) {
                    setMessageForEmptyList(com.telkomsigma.telkomstorage.R.string.file_list_empty_shared_headline,
                            com.telkomsigma.telkomstorage.R.string.file_list_empty_shared, com.telkomsigma.telkomstorage.R.drawable.ic_list_empty_shared);
                }
            }
        });
    }
    ...
    public void setEmptyListLoadingMessage() {
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                if (mEmptyListContainer != null && mEmptyListMessage != null) {
                    mEmptyListHeadline.setText(com.telkomsigma.telkomstorage.R.string.file_list_loading);
    ...
    protected void setFooterText(String text) {
        if (text != null && text.length() > 0) {
            ((TextView) mListFooterView.findViewById(com.telkomsigma.telkomstorage.R.id.footerText)).setText(text);
            ((TextView) mGridFooterView.findViewById(com.telkomsigma.telkomstorage.R.id.footerText)).setText(text);
