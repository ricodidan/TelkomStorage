...
package com.telkomsigma.telkomstorage.services;
            ...
            if (!operationIntent.hasExtra(EXTRA_ACCOUNT) &&
                ...
                if (action.equals(ACTION_CREATE_SHARE_VIA_LINK)) {  // Create public share via link
                    ...
                    operation = new OAuth2GetAccessToken(
                            getString(com.telkomsigma.telkomstorage.R.string.oauth2_client_id),
                            getString(com.telkomsigma.telkomstorage.R.string.oauth2_redirect_uri),
                            getString(com.telkomsigma.telkomstorage.R.string.oauth2_grant_type),
